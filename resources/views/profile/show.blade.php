...
<div class="bg-background text-foreground min-h-screen">
    ...
    <div class="max-w-7xl mx-auto px-6 py-8">
        ...
        <div>
            ...
            @if($reviews->isEmpty())
            <div class="card p-12 text-center flex flex-col items-center justify-center border border-dashed border-border shadow-none">
            ...
            <ul id="js-reviews" class="space-y-4">
                ...
                <x-review-card :review="$review">
                    ...
                    <x-slot:actions>
                        <a href="{{ route('reviews.show', $review) }}" class="btn btn-outline btn-sm">
                            <!-- TODO: ICON: expand -->
                            View Details
                        </a>
                    </x-slot:actions>
