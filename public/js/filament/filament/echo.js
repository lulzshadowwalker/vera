          ...
          var c = (function () {
              ...
              return (
                (e.prototype.create = function (t) {
                  ...
                  return (
                    (this[n] = u),
                    { number: n, id: r, name: i, callback: u }
                  )
                }),
            ...
            Nn = (function () {
              ...
              return (
                ...
                (e.prototype.removeMember = function (t) {
                  ...
                  return (
                    n && (delete this.members[t.user_id], this.count--),
                    n
                  )
                }),
          ...
          },
          {
            ...
            value: function () {
              ...
              Vue.http.interceptors.push(function (c, s) {
                ;(a.socketId() && c.headers.set('X-Socket-ID', a.socketId()),
                  s())
              })
            },
          },
          {
            ...
            value: function () {
              ...
              axios.interceptors.request.use(function (c) {
                return (
                  a.socketId() && (c.headers['X-Socket-Id'] = a.socketId()),
                  c
                )
              })
            },
