          ...
          o = (e || 'YYYY-MM-DDTHH:mm:ssZ').replace(
            ...
            function (a) {
              switch (a) {
                ...
                case 'w':
                case 'ww':
                  return d.s(r.week(), a === 'w' ? 1 : 2, '0')
                case 'W':
                case 'WW':
                  return d.s(r.isoWeek(), a === 'W' ? 1 : 2, '0')
                case 'k':
                case 'kk':
                  return d.s(
                    String(r.$H === 0 ? 24 : r.$H),
    ...
    function l(m) {
      ...
      for (
        ...
        var C = D[v],
          ...
          q = A && A[0],
          x = A && A[1]
        D[v] = x ? { regex: q, parser: x } : C.replace(/^\[|\]$/g, '')
      }
      return function ($) {
        for (var j = {}, W = 0, U = 0; W < w; W += 1) {
          var g = D[W]
          if (typeof g == 'string') U += g.length
          else {
            var h = g.regex,
              c = g.parser,
              p = $.slice(U),
        ...
        return (
          (function (S) {
            ...
            if (k !== void 0) {
              var T = S.hours
              ;(k ? T < 12 && (S.hours += 12) : T === 12 && (S.hours = 0),
                delete S.afternoon)
            }
          })(j),
          j
    ...
    return function (m, Y, L) {
      ...
      D.parse = function (v) {
        ...
        if (typeof x == 'string') {
          ...
          ;(j && (U = q[2]),
            ...
            (this.$d = (function (p, M, S, k) {
              try {
                ...
                return Z
                  ? new Date(
                      Date.UTC(ee, le, X, pe, De, Le, ge + 60 * Z.offset * 1e3)
                    )
                  : S
                    ? new Date(Date.UTC(ee, le, X, pe, De, Le, ge))
                    : ((me = new Date(ee, le, X, pe, De, Le, ge)),
          ...
          for (var g = x.length, h = 1; h <= g; h += 1) {
            q[1] = x[h - 1]
  ...
  ;(function (n, t) {
    ...
    return function (n, t, s) {
      var i = t.prototype,
        ...
        r = function (a, _, y, f, l) {
          var m = a.name ? a : a.$locale(),
            Y = e(m[_]),
            L = e(m[y]),
            D =
              Y ||
        ...
        o = function () {
          ...
          return {
            months: function (_) {
              return _ ? _.format('MMMM') : r(a, 'months')
            },
            monthsShort: function (_) {
              return _ ? _.format('MMM') : r(a, 'monthsShort', 'months', 3)
            },
            firstDayOfWeek: function () {
              return a.$locale().weekStart || 0
            },
            weekdays: function (_) {
              return _ ? _.format('dddd') : r(a, 'weekdays')
            },
            weekdaysMin: function (_) {
              return _ ? _.format('dd') : r(a, 'weekdaysMin', 'weekdays', 2)
            },
            weekdaysShort: function (_) {
              return _ ? _.format('ddd') : r(a, 'weekdaysShort', 'weekdays', 3)
            },
      ...
      ;((i.localeData = function () {
        ...
        (s.weekdays = function (a) {
          return r(u(), 'weekdays', null, null, a)
        }),
        (s.weekdaysShort = function (a) {
          return r(u(), 'weekdaysShort', 'weekdays', 3, a)
        }),
        (s.weekdaysMin = function (a) {
          return r(u(), 'weekdaysMin', 'weekdays', 2, a)
        }))
    }
  })
})
    ...
    return function (s, i, e) {
      var r,
        u = function (_, y, f) {
          ...
          return m.formatToParts(l)
        },
        d = function (_, y) {
          for (var f = u(_, y), l = [], m = 0; m < f.length; m += 1) {
            var Y = f[m],
              L = Y.type,
              D = Y.value,
              w = n[L]
            w >= 0 && (l[w] = parseInt(D, 10))
          }
          var v = l[3],
            C = v === 24 ? 0 : v,
            A =
      ...
      ;((o.tz = function (_, y) {
        ...
        if (!Number(D)) f = this.utcOffset(0, y)
        else if (
          ((f = e(Y, { locale: this.$L })
        ...
        (o.offsetName = function (_) {
          var y = this.$x.$timezone || e.tz.guess(),
            f = u(this.valueOf(), y, { timeZoneName: _ }).find(function (l) {
      ...
      ;((o.startOf = function (_, y) {
        if (!this.$x || !this.$x.$timezone) return a.call(this, _, y)
        var f = e(this.format('YYYY-MM-DD HH:mm:ss:SSS'), { locale: this.$L })
        return a.call(f, _, y).tz(this.$x.$timezone, !0)
      }),
        (e.tz = function (_, y, f) {
          var l = f && y,
            m = f || y || r,
          ...
          var L = (function (C, A, q) {
              var x = C - 60 * A * 1e3,
                $ = d(x, q)
              if (A === $) return [x, A]
              var j = d((x -= 60 * ($ - A) * 1e3), q)
              return $ === j
                ? [x, $]
                : [C - 60 * Math.min($, j) * 1e3, Math.max($, j)]
            })(e.utc(_, l).valueOf(), Y, m),
            D = L[0],
            w = L[1],
            v = e(D).utcOffset(w)
    ...
    return function (i, e, r) {
      ...
      ;((r.utc = function (l) {
        ...
        (u.utc = function (l) {
          ...
          return l ? m.add(this.utcOffset(), n) : m
        }),
        (u.local = function () {
      ...
      var a = u.utcOffset
      u.utcOffset = function (l, m) {
        var Y = this.$utils().u
        if (Y(l))
          return this.$u ? 0 : Y(this.$offset) ? a.call(this) : this.$offset
        if (
          typeof l == 'string' &&
          ((l = (function (v) {
            v === void 0 && (v = '')
          ...
          return this
        var L = Math.abs(l) <= 16 ? 60 * l : l,
          D = this
        if (m) return ((D.$offset = L), (D.$u = l === 0), D)
        if (l !== 0) {
          var w = this.$u
      ...
      var f = u.diff
      u.diff = function (l, m, Y) {
        if (l && this.$u === l.$u) return f.call(this, l, m, Y)
        var L = this.local(),
          D = r(l).local()
        return f.call(L, D, m, Y)
      }
    }
  })
})
  ...
  ;(function (n, t) {
    ...
    var n = 1e3,
      ...
      w = {
        ...
        m: function g(h, c) {
          if (h.date() < c.date()) return -g(c, h)
          var p = 12 * (c.year() - h.year()) + (c.month() - h.month()),
            M = h.clone().add(p, a),
            S = c - M < 0,
            k = h.clone().add(p + (S ? -1 : 1), a)
        ...
        p: function (g) {
          return (
            { M: a, y, w: o, d, D: f, h: u, m: r, s: e, ms: i, Q: _ }[g] ||
            String(g || '')
              .toLowerCase()
              .replace(/s$/, '')
          )
    ...
    var A = '$isDayjsObject',
      ...
      x = function g(h, c, p) {
        ...
        if (typeof h == 'string') {
          ...
          ;(C[S] && (M = S), c && ((C[S] = c), (M = S)))
          var k = h.split('-')
          if (!M && k.length > 1) return g(k[0])
        } else {
          var T = h.name
          ;((C[T] = h), (M = T))
        }
        return (!p && M && (v = M), M || (!p && v))
      },
      $ = function (g, h) {
        if (q(g)) return g.clone()
        var c = typeof h == 'object' ? h : {}
        return ((c.date = g), (c.args = arguments), new W(c))
      },
      j = w
    ;((j.l = x),
      (j.i = q),
        ...
        return (
          ...
          (h.add = function (c, p) {
            ...
            var k = j.p(p),
              T = function (E) {
                var P = $(S)
                return j.w(P.date(P.date() + Math.round(E * c)), S)
              }
            if (k === a) return this.set(a, this.$M + c)
            if (k === y) return this.set(y, this.$y + c)
            if (k === d) return T(1)
            if (k === o) return T(7)
            var I = ((M = {}), (M[r] = t), (M[u] = s), (M[e] = n), M)[k] || 1,
...
var In = b((Re, Ge) => {
  ;(function (n, t) {
    ...
    function e(u, d, o, a) {
      ...
      switch (o) {
        case 's':
          return d || a ? 'p\xE1r sekund' : 'p\xE1r sekundami'
        case 'm':
          return d ? 'minuta' : a ? 'minutu' : 'minutou'
        case 'mm':
          return d || a ? _ + (i(u) ? 'minuty' : 'minut') : _ + 'minutami'
        case 'h':
          return d ? 'hodina' : a ? 'hodinu' : 'hodinou'
        case 'hh':
          return d || a ? _ + (i(u) ? 'hodiny' : 'hodin') : _ + 'hodinami'
        case 'd':
          return d || a ? 'den' : 'dnem'
        case 'dd':
          return d || a ? _ + (i(u) ? 'dny' : 'dn\xED') : _ + 'dny'
        case 'M':
          return d || a ? 'm\u011Bs\xEDc' : 'm\u011Bs\xEDcem'
        case 'MM':
          return d || a
            ? _ + (i(u) ? 'm\u011Bs\xEDce' : 'm\u011Bs\xEDc\u016F')
            : _ + 'm\u011Bs\xEDci'
        case 'y':
          return d || a ? 'rok' : 'rokem'
        case 'yy':
          return d || a ? _ + (i(u) ? 'roky' : 'let') : _ + 'lety'
      }
    }
    var r = {
      name: 'cs',
...
var Nn = b((Xe, Be) => {
  ;(function (n, t) {
    ...
    function e(u, d, o) {
      var a = i[o]
      return (Array.isArray(a) && (a = a[d ? 0 : 1]), a.replace('%d', u))
    }
    var r = {
      name: 'de',
      weekdays:
  ...
  ;(function (n, t) {
    typeof et == 'object' && typeof tt < 'u'
      ...
      : typeof define == 'function' && define.amd
        ? define(['dayjs'], t)
        : ((n =
            typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_el =
            t(n.dayjs))
  })(et, function (n) {
    'use strict'
    function t(e) {
...
var Wn = b((at, ut) => {
  ;(function (n, t) {
    ...
    function i(r, u, d, o) {
      ...
      return u
        ? (a[d][2] ? a[d][2] : a[d][1]).replace('%d', r)
        : (o ? a[d][0] : a[d][1]).replace('%d', r)
    }
    var e = {
      name: 'et',
      weekdays:
  ...
  ;(function (n, t) {
    ...
    function i(r, u, d, o) {
      var a = {
        ...
        y = o && !u ? _ : a,
        f = y[d]
      return r < 10 ? f.replace('%d', y.numbers[r]) : f.replace('%d', r)
    }
    var e = {
      name: 'fi',
      weekdays:
    ...
    var s = t(n),
      i = {
        ...
        relativeTime: {
          ...
          past: '%s',
          s: function (e, r, u, d) {
            return 'n\xE9h\xE1ny m\xE1sodperc' + (d || r ? '' : 'e')
          },
          m: function (e, r, u, d) {
...
var ti = b((wt, $t) => {
  ;(function (n, t) {
    ...
    var s = t(n),
      ...
      u = function (o, a) {
        return r.test(a) ? i[o.month()] : e[o.month()]
      }
    ;((u.s = e), (u.f = i))
    var d = {
      name: 'lt',
  ...
  ;(function (n, t) {
    ...
    function e(_, y, f) {
      ...
      switch (f) {
        ...
        case 'mm':
          return l + (i(_) ? 'minuty' : 'minut')
        case 'h':
          return y ? 'godzina' : 'godzin\u0119'
        case 'hh':
          return l + (i(_) ? 'godziny' : 'godzin')
        case 'MM':
          return l + (i(_) ? 'miesi\u0105ce' : 'miesi\u0119cy')
        case 'yy':
          return l + (i(_) ? 'lata' : 'lat')
      }
    }
    var r =
...
var fi = b((Kt, Qt) => {
  ;(function (n, t) {
    ...
    var a = function (f, l) {
      return d.test(l) ? i[f.month()] : e[f.month()]
    }
    ;((a.s = e), (a.f = i))
    var _ = function (f, l) {
      return d.test(l) ? r[f.month()] : u[f.month()]
    }
    ;((_.s = u), (_.f = r))
    var y = {
      name: 'ru',
...
var hi = b((rn, an) => {
  ;(function (n, t) {
    ...
    var d = function (a, _) {
      return r.test(_) ? i[a.month()] : e[a.month()]
    }
    ;((d.s = e), (d.f = i))
    var o = {
      name: 'uk',
...
var be = function (t, s, i) {
  ...
  Oi = function n(t, s) {
    ...
    var i = (s.year() - t.year()) * 12 + (s.month() - t.month()),
      e = t.clone().add(i, R),
      r = s - e < 0,
      u = t.clone().add(i + (r ? -1 : 1), R)
    return +(-(i + (s - e) / (r ? e - u : u - e)) || 0)
  },
  zi = function (t) {
...
var xi = function (t) {
    ...
    if (typeof s == 'string' && !/Z$/i.test(s)) {
      ...
      if (e) {
        ...
        return i
          ? new Date(
              Date.UTC(e[1], r, e[3] || 1, e[4] || 0, e[5] || 0, e[6] || 0, u)
            )
          : new Date(e[1], r, e[3] || 1, e[4] || 0, e[5] || 0, e[6] || 0, u)
      }
    }
    return new Date(s)
  },
    ...
    return (
      ...
      (t.startOf = function (i, e) {
        var r = this,
          ...
          d = z.p(i),
          o = function (D, w) {
            var v = z.w(r.$u ? Date.UTC(r.$y, w, D) : new Date(r.$y, w, D), r)
            return u ? v : v.endOf(V)
          },
          a = function (D, w) {
            var v = [0, 0, 0, 0],
              C = [23, 59, 59, 999]
            return z.w(
              r.toDate()[D].apply(r.toDate('s'), (u ? v : C).slice(w)),
              r
            )
          },
          _ = this.$W,
        ...
        switch (d) {
          ...
          case oe: {
            var m = this.$locale().weekStart || 0,
              Y = (_ < m ? _ + 7 : _) - m
            return o(u ? f - Y : f + (6 - Y), y)
          }
          case V:
          case se:
            return a(l + 'Hours', 0)
          case ie:
            return a(l + 'Minutes', 1)
          case ne:
            return a(l + 'Seconds', 2)
          case te:
            return a(l + 'Milliseconds', 3)
          default:
            return this.clone()
        }
      }),
      ...
      (t.add = function (i, e) {
        ...
        var d = z.p(e),
          o = function (f) {
            var l = F(r)
            return z.w(l.date(l.date() + Math.round(f * i)), r)
          }
        if (d === R) return this.set(R, this.$M + i)
        if (d === K) return this.set(K, this.$y + i)
        if (d === V) return o(1)
        if (d === oe) return o(7)
        var a = ((u = {}), (u[ne] = ce), (u[ie] = ve), (u[te] = ae), u)[d] || 1,
          _ = this.$d.getTime() + i * a
        return z.w(_, this)
      }),
      ...
      (t.format = function (i) {
        ...
        var u = i || pn,
          ...
          l = r.meridiem,
          m = function (v, C, A, q) {
            return (v && (v[C] || v(e, u))) || A[C].slice(0, q)
          },
          Y = function (v) {
            return z.s(o % 12 || 12, v, '0')
          },
          L =
            l ||
            function (w, v, C) {
        ...
        return u.replace(Ln, function (w, v) {
          return v || D(w) || d.replace(':', '')
        })
      }),
      ...
      (t.diff = function (i, e, r) {
        var u = this,
          d = z.p(e),
          o = F(i),
          a = (o.utcOffset() - this.utcOffset()) * ce,
          _ = this - o,
          y = function () {
            return z.m(u, o)
          },
  ...
  return {
    ...
    init: function () {
      ;(O.locale(pi[e] ?? pi.en),
        this.$nextTick(() => {
          ;(this.focusedDate ??
            (this.focusedDate = (this.getDefaultFocusedDate() ?? O()).tz(d)),
      ...
      ;(((this.getMaxDate() !== null && o.isAfter(this.getMaxDate())) ||
        (this.getMinDate() !== null && o.isBefore(this.getMinDate()))) &&
        (o = null),
        (this.hour = o?.hour() ?? 0),
        ...
        this.$watch('focusedYear', () => {
          if (
            ...
            return
          let a = +this.focusedYear
          ;(Number.isInteger(a) ||
            ((a = O().tz(d).year()), (this.focusedYear = a)),
            this.focusedDate.year() !== a &&
              (this.focusedDate = this.focusedDate.year(a)))
        }),
        this.$watch('focusedDate', () => {
          let a = this.focusedDate.month(),
            _ = this.focusedDate.year()
          ;(this.focusedMonth !== a && (this.focusedMonth = a),
        ...
        this.$watch('state', () => {
          ...
          let a = this.getSelectedDate()
          if (a === null) {
            this.clearState()
            return
          }
          ;(this.getMaxDate() !== null &&
            a?.isAfter(this.getMaxDate()) &&
            (a = null),
            this.getMinDate() !== null &&
              a?.isBefore(this.getMinDate()) &&
              (a = null))
          let _ = a?.hour() ?? 0
          ...
          let f = a?.second() ?? 0
          ;(this.second !== f && (this.second = f), this.setDisplayText())
        }))
    },
    clearState: function () {
      ...
      return !!(
        (this.$refs?.disabledDates &&
          JSON.parse(this.$refs.disabledDates.value ?? []).some(
            (a) => ((a = O(a)), a.isValid() ? a.isSame(o, 'day') : !1)
          )) ||
    ...
    dayIsSelected: function (o) {
      ...
      return a === null
        ...
        : (this.focusedDate ?? (this.focusedDate = O().tz(d)),
          a.date() === o &&
            a.month() === this.focusedDate.month() &&
            a.year() === this.focusedDate.year())
    },
    dayIsToday: function (o) {
      let a = O().tz(d)
      return (
        this.focusedDate ?? (this.focusedDate = a),
        a.date() === o &&
          a.month() === this.focusedDate.month() &&
          a.year() === this.focusedDate.year()
      )
    ...
    getDayLabels: function () {
      ...
      return s === 0 ? o : [...o.slice(s), ...o.slice(0, s)]
    },
    getMaxDate: function () {
    ...
    setupDaysGrid: function () {
      ;(this.focusedDate ?? (this.focusedDate = O().tz(d)),
        (this.emptyDaysInFocusedMonth = Array.from(
          { length: this.focusedDate.date(8 - s).day() },
          (o, a) => a + 1
        )),
