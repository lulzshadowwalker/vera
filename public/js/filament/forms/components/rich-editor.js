  ...
  $i = function (i) {
    ...
    return t
      ...
      : Vt(i) ||
          (!Vt(i.firstChild) &&
            (function (e) {
              return ge().includes(W(e)) && !ge().includes(W(e.firstChild))
            })(i))
  },
...
var lr = z([
  ...
  Ve = (function i() {
        ...
        if (!Wt || Wt !== a) {
          if (
            ...
            (Oi = Y(a, 'ADD_DATA_URI_TAGS')
              ...
              : Fi),
            (_t = Y(a, 'FORBID_CONTENTS') ? b({}, a.FORBID_CONTENTS, I) : Ii),
    ...
    let Vi = function (a) {
        let g = null
        if ((st(B.beforeSanitizeElements, a, null), En(a))) return (tt(a), !0)
        let h = I(a.nodeName)
        if (
          (st(B.uponSanitizeElement, a, { tagName: h, allowedTags: N }),
          (a.hasChildNodes() &&
                ...
                : v.namespaceURI === ke
                  ...
                  : v.namespaceURI === ot
                    ? !(A.namespaceURI === Re && !we[D]) &&
                      ...
                      !_i[f] &&
                      (uo[f] || !Bi[f])
                    : !(ie !== 'application/xhtml+xml' || !xn[v.namespaceURI]))
            )
          })(a)
          ? (tt(a), !0)
    ...
    return (
      (e.sanitize = function (a) {
        ...
        if (
          (fn || Cn(g), (e.removed = []), typeof a == 'string' && (ne = !1), ne)
        ) {
          if (a.nodeName) {
            let et = I(a.nodeName)
            if (!N[et] || ee[et])
        ...
        if (Mt) {
          ...
          return (
            (O.shadowroot || O.shadowrootmode) && (f = ro.call(r, f, !0)),
            f
          )
        }
  ...
  Jt = class extends dt {
    ...
    render() {
      if (
        ...
        let t = be.groupObjects(this.document.getBlocks(), { asTree: !0 })
        Array.from(t).forEach((e) => {
...
`,
    ...
    isBlockElement(t) {
      if (
        ...
        return (
          ge().includes(W(t)) || window.getComputedStyle(t).display === 'block'
        )
    }
...
` &&
  ...
  Ps = function (i) {
    return Ms(i) === NodeFilter.FILTER_ACCEPT ? $r(i) : NodeFilter.FILTER_REJECT
  },
  Ms = function (i) {
  ...
  ct = class extends R {
    ...
    selectionIsCollapsed() {
      var t
      return ((t = pe()) === null || t === void 0 ? void 0 : t.collapsed) === !0
    }
    selectionIsExpanded() {
  ...
  paste(i) {
    ...
    if (n) {
      ...
      ;((e.type = 'text/html'),
        ...
        (J = this.responder) === null || J === void 0 || J.insertHTML(e.html),
        this.requestRender(),
      ...
      if (F) {
        var yt, Qt, te
        let k = qs(F)
        ;(!F.name && k && (F.name = 'pasted-file-'.concat(++Hs, '.').concat(k)),
          (e.type = 'File'),
          (e.file = F),
...
var qs = (i) => {
  ...
  Js = !((Hn = ' '.codePointAt) === null || Hn === void 0 || !Hn.call(' ', 0)),
  Ks = function (i) {
