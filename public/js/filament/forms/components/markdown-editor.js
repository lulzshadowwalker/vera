...
var We = Ke((Yo, Qo) => {
  ;(function (o, p) {
    ...
    var o = navigator.userAgent,
      ...
      M = /PhantomJS/.test(o),
      w = k && (/Mobile\/\w+/.test(o) || navigator.maxTouchPoints > 2),
      W = /Android/.test(o),
    ...
    function se(e, t, n) {
      for (; (n < 0 ? t > 0 : t < e.length) && B(e.charAt(t)); ) t += n
      return t
    }
    function De(e, t, n) {
      for (var r = t > n ? -1 : 1; ; ) {
    ...
    var Ft = (function () {
      ...
      var r = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/,
        ...
        u = /[1n]/
      function f(m, A, j) {
        ;((this.level = m), (this.from = A), (this.to = j))
      }
      return function (m, A) {
        var j = A == 'ltr' ? 'L' : 'R'
        if (m.length == 0 || (A == 'ltr' && !r.test(m))) return !1
        for (var ee = m.length, Y = [], ie = 0; ie < ee; ++ie)
          Y.push(n(m.charCodeAt(ie)))
        for (var ue = 0, me = j; ue < ee; ++ue) {
          var ve = Y[ue]
          ve == 'm' ? (Y[ue] = me) : (me = ve)
        }
        for (var _e = 0, be = j; _e < ee; ++_e) {
          var Ce = Y[_e]
          Ce == '1' && be == 'r'
            ? (Y[_e] = 'n')
        ...
        return (
          A == 'ltr' &&
            ...
            ce(St).level == 1 &&
              ...
              St.push(new f(0, ee - rr[0].length, ee)))),
          A == 'rtl' ? St.reverse() : St
        )
      }
    })()
    ...
    function ei(e) {
      if (Br == null) {
        var t = x('span', '\u200B')
        ;(V(e, x('span', [t, document.createTextNode('x')])),
    ...
    function pr(e) {
      ...
      return (R(e), !n || n.left == n.right ? !1 : (xn = r.right - n.right < 3))
    }
    var Bt =
        `
            ...
            ;((n.state = !0),
              va(
                ...
                function (Y, ie) {
                  for (var ue = j; ee < Y; ) {
                    var me = i[j]
                    ;(me > Y && i.splice(j, 1, Y, i[j + 1], me),
                      (j += 2),
                      (ee = Math.min(Y, me)))
                  }
                  if (ie)
                    if (A.opaque)
                      (i.splice(ue, j - ue, Y, 'overlay ' + ie), (j = ue + 2))
                    else
                      for (; ue < j; ue += 2) {
                        var ve = i[ue + 1]
        ...
        for (var l = r[a], u = l.find(0), f = 0; f < i.length; ++f) {
          ...
          if (!(ye(m.to, u.from) < 0 || ye(m.from, u.to) > 0)) {
            var A = [f, 1],
              j = ye(m.from, u.from),
              ee = ye(m.to, u.to)
            ;((j < 0 || (!l.inclusiveLeft && !j)) &&
              A.push({ from: m.from, to: u.from }),
              (ee > 0 || (!l.inclusiveRight && !ee)) &&
      ...
      if (t) {
        ...
        if (!f.test(t))
          ...
          for (var j = 0; ; ) {
            f.lastIndex = j
            var ee = f.exec(t),
              Y = ee ? ee.index - j : t.length - j
            if (Y) {
              var ie = document.createTextNode(u.slice(j, j + Y))
              ;(s && h < 9 ? A.appendChild(x('span', [ie])) : A.appendChild(ie),
            ...
            if (ee[0] == '	') {
              var me = e.cm.options.tabSize,
                ve = me - (e.col % me)
              ;((ue = A.appendChild(x('span', Z(ve), 'cm-tab'))),
...
`
    ...
    function Uc(e, t) {
      return function (n, r, i, a, l, u, f) {
        ...
        for (var m = n.pos, A = m + r.length; ; ) {
          for (
            var j = void 0, ee = 0;
            ee < t.length && ((j = t[ee]), !(j.to > m && j.from <= m));
            ee++
          );
          if (j.to >= A) return e(n, r, i, a, l, u, f)
          ;(e(n, r.slice(0, j.to - m), i, a, null, u, f),
            (a = null),
            (r = r.slice(j.to - m)),
            (m = j.to))
        }
    ...
    function $c(e, t, n) {
      ...
      for (
        ...
        if (Y == f) {
          ;((ie = ue = me = ee = ''), (_e = null), (ve = null), (Y = 1 / 0))
          for (var be = [], Ce = void 0, Ne = 0; Ne < r.length; ++Ne) {
            var Fe = r[Ne],
              $e = Fe.marker
            if ($e.type == 'bookmark' && Fe.from == f && $e.widgetNode)
              be.push($e)
            else if (
              Fe.from <= f &&
              (Fe.to == null ||
                Fe.to > f ||
                ($e.collapsed && Fe.to == f && Fe.from == f))
            ) {
              if (
                (Fe.to != null &&
                  Fe.to != f &&
        ...
        for (var Ot = Math.min(u, Y); ; ) {
          ...
          ;((A = i.slice(a, (a = n[m++]))), (j = La(n[m++], t.cm.options)))
        }
      }
    }
    function za(e, t, n) {
    ...
    function Cn(e) {
      ...
      if (!N(document.body, e.node)) {
        ...
        ;(e.coverGutter &&
          ...
          V(t.display.measure, x('div', [e.node], null, n)))
      }
    ...
    function Ia(e) {
      ...
      var t = V(e.measure, x('pre', 'x', 'CodeMirror-line-like')),
    ...
    function of(e, t, n, r) {
      ...
      if (a.nodeType == 3) {
        for (var A = 0; A < 4; A++) {
          for (; l && B(t.line.text.charAt(i.coverStart + l)); ) --l
          for (
            ;
            i.coverStart + u < i.coverEnd &&
            B(t.line.text.charAt(i.coverStart + u));
          )
            ++u
          if (
        ...
        l > 0 && (f = r = 'right')
        var j
        e.options.lineWrapping && (j = a.getClientRects()).length > 1
          ? (m = j[r == 'right' ? j.length - 1 : 0])
    ...
    function lf(e, t, n, r, i) {
      ...
      if (A) {
        var j = (e.options.lineWrapping ? uf : sf)(e, t, n, a, A, r, i)
        ;((m = j.level != 1),
          (u = m ? j.from : j.to - 1),
          (f = m ? j.to : j.from - 1))
      }
        ...
        ie = De(
          function (Ne) {
            ...
            return (
              ...
              (Fe.bottom += l),
              vo(Fe, r, i, !1)
                ? (Fe.top <= i && Fe.left <= r && ((ee = Ne), (Y = Fe)), !0)
                : !1
            )
          },
          u,
      ...
      var u = De(
          function (j) {
            ...
            return vo(
              Xt(
                e,
                ne(n, Y ? ee.to : ee.from, Y ? 'before' : 'after'),
                'line',
                t,
                r
              ),
    ...
    function uf(e, t, n, r, i, a, l) {
      ...
      for (var A = null, j = null, ee = 0; ee < i.length; ee++) {
        var Y = i[ee]
        if (!(Y.from >= m || Y.to <= f)) {
          var ie = Y.level != 1,
            ue = tr(
    ...
    function Vr(e) {
      ...
      if (zr == null) {
        zr = x('pre', null, 'CodeMirror-line-like')
        for (var t = 0; t < 49; ++t)
    ...
    function Mr(e, t, n, r) {
      ...
      if (r && f.xRel > 0 && (m = Ae(e.doc, f.line).text).length == f.ch) {
        ...
        f = ne(
          f.line,
          Math.max(0, Math.round((a - Ia(e.display).left) / Jr(e.display)) - A)
        )
      }
      return f
    }
    ...
    function _o(e, t, n) {
      ...
      if (r.other) {
        var u = n.appendChild(
          x('div', '\xA0', 'CodeMirror-cursor CodeMirror-secondarycursor')
        )
        ;((u.style.display = ''),
    ...
    function ff(e, t, n) {
        ...
        function Ot(ut, Dt, yt) {
          var ft = Ga(e, Fe, null, ut),
            ...
            lt =
              yt == 'after'
                ? ft.begin
                : ft.end - (/\s/.test(Fe.text.charAt(ft.end - 1)) ? 2 : 1)
          return rt(lt, ct)[ct]
        }
      ...
      var ee = t.from(),
        Y = t.to()
      if (ee.line == Y.line) j(ee.line, ee.ch, Y.ch)
      else {
        var ie = Ae(i, ee.line),
          ue = Ae(i, Y.line),
          me = Zt(ie) == Zt(ue),
          ve = j(ee.line, ee.ch, me ? ie.text.length + 1 : null).end,
          _e = j(Y.line, me ? 0 : null, Y.ch).start
        ;(me &&
          (ve.top < _e.top - 2
      ...
      for (
        ...
        if (!u.hidden) {
          if (((i += u.line.height), s && h < 8)) {
            var j = u.node.offsetTop + u.node.offsetHeight
            ;((m = j - n), (n = j))
          } else {
    ...
    function pf(e, t, n, r) {
      ...
      for (var a = 0; a < 5; a++) {
        ...
        if (
          ...
          m.scrollLeft != null &&
            (Dr(e, m.scrollLeft),
            Math.abs(e.doc.scrollLeft - j) > 1 && (l = !0)),
          !l)
        )
          break
      }
    ...
    function To(e, t) {
      ...
      var j = e.options.fixedGutter ? 0 : n.gutters.offsetWidth,
        ee =
          e.curOp && e.curOp.scrollLeft != null
            ? e.curOp.scrollLeft
            : n.scroller.scrollLeft - j,
      ...
      return (
        ...
        t.left < 10
          ? (l.scrollLeft = 0)
          : t.left < ee
            ? (l.scrollLeft = Math.max(0, t.left + j - (ie ? 0 : 10)))
            : t.right > Y + ee - 3 &&
    ...
    function kf(e) {
      ...
      if (a)
        for (var u = 0; u < a.length; ++u) a[u].lines.length || it(a[u], 'hide')
      if (l)
          ...
          function (a) {
            if (r.line >= e.display.viewFrom) {
              ...
              for (
                ...
                j = l[ee] != a.styles[ee]
              ;(j && i.push(r.line), (a.stateAfter = r.save()), r.nextLine())
            } else
              (a.text.length <= e.options.maxHighlightLength &&
                ro(e, a.text, r),
    ...
    function Cf(e, t, n) {
      ...
      function u(ie) {
        ...
        return (
          g && O && e.display.currentWheelTarget == ie
      ...
      for (var f = r.view, m = r.viewFrom, A = 0; A < f.length; A++) {
        var j = f[A]
        if (!j.hidden)
          if (!j.node || j.node.parentNode != a) {
            var ee = Jc(e, j, m, n)
            a.insertBefore(ee, l)
          } else {
            for (; l != j.node; ) l = u(l)
            var Y = i && t != null && t <= m && j.lineNumber
            ;(j.changes &&
              (Se(j.changes, 'gutter') > -1 && (Y = !1), Ma(e, j, m, n)),
              Y &&
                (R(j.lineNumber),
                j.lineNumber.appendChild(
                  document.createTextNode(he(e.options, m))
                )),
              (l = j.node.nextSibling))
          }
        m += j.size
      }
      for (; l; ) l = u(l)
    ...
    function Ef(e, t, n, r) {
      ...
      ;((i.mover = x('div', [a], null, 'position: relative')),
        ...
        y && c >= 105 && (i.wrapper.style.clipPath = 'inset(0px)'),
    ...
    var bi = 0,
      sr = null
    s ? (sr = -0.53) : v ? (sr = 15) : y ? (sr = -0.7) : k && (sr = -1 / 3)
    function sl(e) {
      var t = e.wheelDeltaX,
        n = e.wheelDeltaY
      return (
    ...
    function ul(e, t) {
      ...
      if ((r && f) || (i && m)) {
        if (i && O && g) {
          e: for (var A = t.target, j = l.view; A != u; A = A.parentNode)
      ...
      for (var a = 1; a < t.length; a++) {
        ...
        if (r && !l.empty() ? f > 0 : f >= 0) {
          var m = Zr(u.from(), l.from()),
            A = Et(u.to(), l.to()),
            j = u.empty() ? l.from() == l.head : u.from() == u.head
          ;(a <= n && --n, t.splice(--a, 2, new Ye(j ? A : m, j ? m : A)))
        }
      }
      return new Rt(t, n)
    }
      ...
      for (var r = [], i = ne(e.first, 0), a = i, l = 0; l < t.length; l++) {
        ...
        if (((i = u.to), (a = m), n == 'around')) {
          var A = e.sel.ranges[l],
            j = ye(A.head, A.anchor) < 0
          r[l] = new Ye(j ? m : f, j ? f : m)
        } else r[l] = new Ye(f, f)
      }
    ...
    function Fo(e, t, n, r) {
      ...
      if (t.full)
        ...
        if (m.length == 1)
          a(A, A.text.slice(0, u.ch) + ee + A.text.slice(f.ch), Y)
        else {
        ...
        (a(A, A.text.slice(0, u.ch) + m[0] + j.text.slice(f.ch), i(0)),
          e.remove(u.line + 1, ie))
      else {
        ;(a(A, A.text.slice(0, u.ch) + m[0], i(0)),
          a(j, ee + j.text.slice(f.ch), Y))
    ...
    function ki(e, t, n) {
      ;(It(e, 'beforeSelectionChange') ||
        (e.cm && It(e.cm, 'beforeSelectionChange'))) &&
        (t = Of(e, t, n))
      var r =
        (n && n.bias) ||
        ...
        for (var l = 0; l < a.markedSpans.length; ++l) {
          ...
          if (
            ...
            if (n) {
              ...
              if (
                ((r < 0 ? A : m) &&
                  (j = Tl(e, j, -r, j && j.line == t.line ? a : null)),
                j &&
                  j.line == t.line &&
                  (ee = ye(j, n)) &&
                  (r < 0 ? ee < 0 : ee > 0))
    ...
    function Si(e, t, n) {
      ...
      if (!(r && !n)) {
        ...
        if (m != u.length) {
          ...
          for (
            var j = It(e, 'beforeChange') || (e.cm && It(e.cm, 'beforeChange')),
              ee = function (ue) {
                var me = a.changes[ue]
                if (((me.origin = t), j && !Cl(e, me, !1)))
                  return ((u.length = 0), {})
                A.push(Io(e, me))
    ...
    ;((kr.prototype.clear = function () {
      ...
      (kr.prototype.find = function (e, t) {
        ...
        for (var n, r, i = 0; i < this.lines.length; ++i) {
          ...
          if (l.from != null && ((n = ne(t ? a : _(a), l.from)), e == -1))
            return n
    ...
    function sn(e, t, n, r, i) {
      ...
      var u = t.line,
        ...
        m
      if (
        (e.iter(u, n.line + 1, function (j) {
          ;(f &&
            a.collapsed &&
            !f.options.lineWrapping &&
            Zt(j) == f.display.maxLine &&
            (m = !0),
            a.collapsed && u != t.line && jt(j, 0),
            Mc(
              j,
        ...
        a.collapsed &&
          e.iter(t.line, n.line + 1, function (j) {
            mr(e, j) && jt(j, 0)
          }),
        a.clearOnEnter &&
      ...
      unlinkDoc: function (e) {
        if ((e instanceof tt && (e = e.doc), this.linked))
          for (var t = 0; t < this.linked.length; ++t) {
            var n = this.linked[t]
            if (n.doc == e) {
              ;(this.linked.splice(t, 1), e.unlinkDoc(this), Bf(Il(this)))
              break
            }
          }
...
`
            ...
            try {
              ...
              if (A) {
                ...
                if (
                  ...
                  for (var ee = 0; ee < j.length; ++ee)
                    ln(t.doc, '', j[ee].anchor, j[ee].head, 'drag')
    ...
    ;((ur.basic = {
      ...
      (ur.default = O ? ur.macDefault : ur.pcDefault))
    function Yf(e) {
      var t = e.split(/-(?!$)/)
      e = t[t.length - 1]
    ...
    function Vf(e, t, n, r) {
      ...
      if (e.doc.direction == 'rtl' || l.level == 1) {
        ...
        if (
          ee != null &&
          (j ? ee <= l.to && ee <= A.end : ee >= l.from && ee >= A.begin)
        ) {
          var Y = j ? 'before' : 'after'
...
`,
    ...
    function Wl(e, t) {
      var n = Ae(e.doc, t),
        r = Zt(n)
      return (r != n && (t = _(r)), Ro(!0, e, r, t, 1))
    }
    function Jf(e, t) {
      var n = Ae(e.doc, t),
        r = Ic(n)
      return (r != n && (t = _(r)), Ro(!0, e, n, t, -1))
    }
    function Ul(e, t) {
      var n = Wl(e, t.line),
        r = Ae(e.doc, n.line),
            ...
            !(r && ad(t, i, r, a, e)) &&
              (i == 1
                ...
                : i == 2
                  ...
                  : i == 3 && (I ? t.display.input.onContextMenu(e) : wo(t))))
        }
      }
    }
    ...
    function ld(e, t, n) {
      var r = e.getOption('configureMouse'),
        i = r ? r(e, t, n) : {}
      if (i.unit == null) {
        var a = G ? n.shiftKey && n.metaKey : n.altKey
        i.unit = a
          ? 'rectangle'
          : t == 'single'
            ? 'char'
      ...
      return (
        ...
        i.addNew == null && (i.addNew = O ? n.metaKey : n.ctrlKey),
        i.moveOnDrag == null && (i.moveOnDrag = !(O ? n.altKey : n.ctrlKey)),
        i
      )
    }
    function sd(e, t, n, r) {
      s ? setTimeout(Ee(Qa, e), 0) : (e.curOp.focus = H(de(e)))
      var i = ld(e, n, r),
        a = e.doc.sel,
        l
      e.options.dragDrop &&
    ...
    function cd(e, t, n, r) {
      ...
      ;((e.state.selectingText = _e),
        ...
        Ie(i.wrapper.ownerDocument, 'mouseup', _e))
    }
    function fd(e, t) {
      var n = t.anchor,
        r = t.head,
      ...
      if (r.line != n.line)
        ...
        var A = Pt(a, r.ch, r.sticky),
          j = A - l || (r.ch - n.ch) * (u.level == 1 ? -1 : 1)
        A == f - 1 || A == f ? (m = j < 0) : (m = j > 0)
      }
      var ee = a[f + (m ? -1 : 0)],
        Y = m == (ee.level == 1),
        ie = Y ? ee.from : ee.to,
    ...
    function Vl(e, t, n, r) {
      ...
      for (var f = 0; f < e.display.gutterSpecs.length; ++f) {
        ...
        if (m && m.getBoundingClientRect().right >= i) {
          var A = P(e.doc, a),
            j = e.display.gutterSpecs[f]
          return (it(e, n, e, A, j.className, t), Ct(t))
        }
      }
    }
    function Wo(e, t) {
          ...
          if (
            ...
            ;(!m.prev || l(m, m.prev)
              ...
              : !m.prev.prev || l(m, m.prev.prev)
                ? (j = e.findWordAt(A))
                : (j = new Ye(ne(A.line, 0), Re(e.doc, ne(A.line + 1, 0)))),
              e.setSelection(j.anchor, j.head),
              e.focus(),
              kt(f))
          }
          i()
    ...
    function Xn(e, t, n, r) {
      ...
      if (e.options.indentWithTabs)
        for (var Y = Math.floor(A / l); Y; --Y) ((ee += l), (j += '	'))
      if ((ee < A && (j += Z(A - ee)), j != m))
        return (
          ln(i, j, ne(t, 0), ne(t, m.length), '+input'),
          (u.stateAfter = null),
          !0
        )
...
`) == t
      ...
      for (
        var j = e.curOp.updateInput, ee = r.ranges.length - 1;
        ee >= 0;
        ee--
      ) {
        var Y = r.ranges[ee],
...
`) &&
      ...
      ;(t && !u && ns(e, t),
        tn(e),
        e.curOp.updateInput < 2 && (e.curOp.updateInput = j),
        (e.curOp.typing = !0),
      ...
      ;((e.prototype = {
        ...
        getHelpers: function (r, i) {
          ...
          for (var A = 0; A < l._global.length; A++) {
            var j = l._global[A]
            j.pred(u, this) && Se(a, j.val) == -1 && a.push(j.val)
          }
          return a
        },
        ...
        addWidget: function (r, i, a, l, u) {
          ...
          if (
            ...
            var j = Math.max(f.wrapper.clientHeight, this.doc.height),
              ee = Math.max(f.sizer.clientWidth, f.lineSpace.clientWidth)
            ;((l == 'above' || r.bottom + i.offsetHeight > j) &&
            r.top > i.offsetHeight
              ? (m = r.top - i.offsetHeight)
              : r.bottom + i.offsetHeight <= j && (m = r.bottom),
        ...
        moveV: Tt(function (r, i) {
          ...
          if (
            (l.extendSelectionsBy(function (A) {
              ...
              var j = Xt(a, A.head, 'div')
              ;(A.goalColumn != null && (j.left = A.goalColumn), u.push(j.left))
              var ee = as(a, j, r, i)
              return (
                i == 'page' &&
                  A == l.sel.primary() &&
                  Lo(a, fi(a, ee, 'div').top - j.top),
                ee
              )
            }, He),
            u.length)
        ...
        hasFocus: function () {
          return this.display.input.getField() == H(de(this))
        },
        isReadOnly: function () {
...
`
                ...
                : !ee || /\s/.test(ue)
                  ? null
                  : 'p'
          if ((ee && !ie && !me && (me = 's'), j && j != me)) {
            n < 0 && ((n = 1), A(), (t.sticky = 'after'))
            break
          }
          if ((me && (j = me), n > 0 && !A(!ie))) break
        }
      var ve = wi(e, t, a, l, !0)
...
`)))
        ...
        if (
          ...
          if (!m) {
            var A = u[u.length - 1].measure,
              j = A.maps ? A.maps[A.maps.length - 1] : A.map
            m = {
              node: j[j.length - 1],
      ...
      (Qe.prototype.focus = function () {
        this.cm.options.readOnly != 'nocursor' &&
          ((!this.selectionInEditor() || H(ze(this.div)) != this.div) &&
      ...
      (Qe.prototype.pollContent = function () {
        ...
        if (
          ...
          return !1
        for (
          var j = e.doc.splitLines(yd(e, u, A, l, m)),
            ee = ir(e.doc, ne(l, 0), ne(m, Ae(e.doc, m).text.length));
          j.length > 1 && ee.length > 1;
        )
          if (ce(j) == ce(ee)) (j.pop(), ee.pop(), m--)
          else if (j[0] == ee[0]) (j.shift(), ee.shift(), l++)
          else break
        for (
          var Y = 0,
            ie = 0,
        ...
        for (
          ...
          ++ie
        if (j.length == 1 && ee.length == 1 && l == r.line)
          for (
            ;
            Y &&
            Y > r.ch &&
        ...
        ;((j[j.length - 1] = _e
          ...
          .replace(/^\u200b+/, '')),
          (j[0] = j[0].slice(Y).replace(/\u200b+$/, '')))
        var Ne = ne(l, Y),
          Fe = ne(m, ee.length ? ce(ee).length - ie : 0)
        if (j.length > 1 || j[0] || ye(Ne, Fe))
          return (ln(e.doc, j, Ne, Fe, '+input'), !0)
      }),
      ...
      function ee(Y) {
        if (Y.nodeType == 1) {
          ...
          if (ue) {
            ...
            ve.length &&
              (me = ve[0].find(0)) &&
              j(ir(e.doc, me.from, me.to).join(u))
            return
          }
          ...
          Y.nodeType == 3 &&
            j(Y.nodeValue.replace(/\u200b/g, '').replace(/\u00a0/g, ' '))
      }
    ...
    function xd(e, t, n) {
      var r = e.text.firstChild,
        i = !1
      if (!t || !N(r, t)) return dn(ne(_(e.line), 0), !0)
      ...
      if (j) return dn(j, i)
      for (
        var ee = u.nextSibling, Y = l ? l.nodeValue.length - n : 0;
        ee;
        ee = ee.nextSibling
      ) {
        if (((j = A(ee, ee.firstChild, 0)), j))
          return dn(ne(j.line, j.ch - Y), i)
        Y += ee.textContent.length
      }
      for (var ie = u.previousSibling, ue = n; ie; ie = ie.previousSibling) {
        if (((j = A(ie, ie.firstChild, -1)), j))
          return dn(ne(j.line, j.ch + ue), i)
...
`)),
      ...
      (st.prototype.focus = function () {
        if (
          this.cm.options.readOnly != 'nocursor' &&
          (!E || H(ze(this.textarea)) != this.textarea)
        )
          try {
            this.textarea.focus()
          } catch {}
...
`) > -1
      ...
      outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);`))
        var j
        ;(g && (j = i.ownerDocument.defaultView.scrollY),
          r.input.focus(),
          g && i.ownerDocument.defaultView.scrollTo(null, j),
          r.input.reset(),
  ...
  ;(function (o) {
    ...
    o.commands.newlineAndIndentContinueMarkdownList = function (S) {
      ...
      for (var s = S.listSelections(), h = [], g = 0; g < s.length; g++) {
        var T = s[g].head,
          y = S.getStateAfter(T.line),
          c = o.innerMode(S.getMode(), y)
        ...
        var d = y.list !== !1,
          ...
          z = S.getLine(T.line),
          M = p.exec(z),
          w = /^\s*$/.test(z.slice(0, T.ch))
        if (!s[g].empty() || (!d && !k) || !M || w) {
          S.execCommand('newlineAndIndent')
          return
        }
        if (v.test(z)) {
...
`))
          ...
          var O = M[1],
            G = M[5],
            J = !(C.test(M[2]) || M[2].indexOf('>') >= 0),
            re = J ? parseInt(M[3], 10) + 1 + M[4] : M[2].replace('x', ' ')
          ;((h[g] =
            `
` +
            O +
        ...
        if (z) {
          ...
          if (c === M && !isNaN(W))
            (w === W && (E = W + 1),
              w > W && (E = w + 1),
              S.replaceRange(
                k.replace(p, M + E + z[4] + z[5]),
                { line: d, ch: 0 },
                { line: d, ch: k.length }
              ))
          else {
            if (c.length > M.length || (c.length < M.length && g === 1)) return
            T += 1
          }
        }
      } while (z)
...
var ys = Ke((vs, bs) => {
  ;(function (o) {
    ...
    'use strict'
    o.defineOption('styleSelectedText', !1, function (y, c, d) {
      var k = d && d != o.Init
      c && !k
        ? ((y.state.markedSelection = []),
          (y.state.markedSelectionStyle =
            typeof c == 'string' ? c : 'CodeMirror-selectedtext'),
          g(y),
          y.on('cursorActivity', p),
          y.on('change', v))
        : !c &&
          k &&
          (y.off('cursorActivity', p),
          y.off('change', v),
          h(y),
          (y.state.markedSelection = y.state.markedSelectionStyle = null))
    })
    function p(y) {
      y.state.markedSelection &&
    ...
    function v(y) {
      y.state.markedSelection &&
        y.state.markedSelection.length &&
        y.operation(function () {
          h(y)
        })
    }
    ...
    function s(y, c, d, k) {
      if (S(c, d) != 0)
        for (
          var z = y.state.markedSelection,
            M = y.state.markedSelectionStyle,
            w = c.line;
          ;
        ) {
          var W = w == c.line ? c : b(w, 0),
            ...
            O = E >= d.line,
            G = O ? d : b(E, 0),
            J = y.markText(W, G, { className: M })
          if ((k == null ? z.push(J) : z.splice(k++, 0, J), O)) break
          w = E
        }
    }
    function h(y) {
      for (var c = y.state.markedSelection, d = 0; d < c.length; ++d)
        c[d].clear()
      c.length = 0
    }
    function g(y) {
      h(y)
      for (var c = y.listSelections(), d = 0; d < c.length; d++)
        s(y, c[d].from(), c[d].to())
    }
    function T(y) {
      if (!y.somethingSelected()) return h(y)
      if (y.listSelections().length > 1) return g(y)
      var c = y.getCursor('start'),
        d = y.getCursor('end'),
        k = y.state.markedSelection
      if (!k.length) return s(y, c, d)
      var z = k[0].find(),
        M = k[k.length - 1].find()
      if (
        !z ||
        ...
        return g(y)
      for (; S(c, z.from) > 0; ) (k.shift().clear(), (z = k[0].find()))
      for (
        S(c, z.from) < 0 &&
        (z.to.line - c.line < C
          ? (k.shift().clear(), s(y, c, z.to, 0))
          : s(y, c, z.from, 0));
        S(d, M.to) < 0;
      )
        (k.pop().clear(), (M = k[k.length - 1].find()))
      S(d, M.to) > 0 &&
        (d.line - M.from.line < C
          ? (k.pop().clear(), s(y, M.from, d))
          : s(y, M.to, d))
    }
  })
})
var ks = Ke((xs, _s) => {
  ;(function (o) {
    ...
    function C(w, W) {
      for (var E = v(w), O = E, G = 0; G < W.length; G++)
        O.indexOf(W.charAt(G)) == -1 && (O += W.charAt(G))
      return E == O ? w : new RegExp(w.source, O)
    }
    function b(w) {
      return /\\s|\\n|\n|\\W|\\D|\[\^/.test(w.source)
    }
    function S(w, W, E) {
      W = C(W, 'g')
      for (var O = E.line, G = E.ch, J = w.lastLine(); O <= J; O++, G = 0) {
        W.lastIndex = G
        var re = w.getLine(O),
          q = W.exec(re)
        if (q)
    ...
    function s(w, W, E) {
      ...
      W = C(W, 'gm')
      for (var O, G = 1, J = E.line, re = w.lastLine(); J <= re; ) {
        for (var q = 0; q < G && !(J > re); q++) {
          var I = w.getLine(J++)
          O =
            O == null
              ? I
...
` +
        ...
        ;((G = G * 2), (W.lastIndex = E.ch))
        var D = W.exec(O)
        if (D) {
          var Q = O.slice(0, D.index).split(`
`),
            R = D[0].split(`
`),
            V = E.line + Q.length - 1,
            x = Q[Q.length - 1].length
          return {
            from: p(V, x),
            to: p(
              V + R.length - 1,
              R.length == 1 ? x + R[0].length : R[R.length - 1].length
            ),
            match: D,
          }
        }
    ...
    function h(w, W, E) {
      for (var O, G = 0; G <= w.length; ) {
        W.lastIndex = G
        var J = W.exec(w)
        if (!J) break
        var re = J.index + J[0].length
        if (re > w.length - E) break
        ;((!O || re > O.index + O[0].length) && (O = J), (G = J.index + 1))
      }
      return O
    }
    function g(w, W, E) {
      W = C(W, 'g')
      for (var O = E.line, G = E.ch, J = w.firstLine(); O >= J; O--, G = -1) {
        var re = w.getLine(O),
          q = h(re, W, G < 0 ? 0 : re.length - G)
        if (q)
          return {
            from: p(O, q.index),
            to: p(O, q.index + q[0].length),
...
` +
        ...
        var Q = h(O, W, J)
        if (Q) {
          var R = O.slice(0, Q.index).split(`
`),
            V = Q[0].split(`
`),
            x = re + R.length,
            K = R[R.length - 1].length
          return {
            from: p(x, K),
            to: p(
              x + V.length - 1,
    ...
    function d(w, W, E, O) {
      ...
      for (var G = 0, J = E + Math.max(0, w.length - W.length); ; ) {
        if (G == J) return G
        var re = (G + J) >> 1,
          q = O(w.slice(0, re)).length
        if (q == E) return re
        q > E ? (J = re) : (G = re + 1)
      }
    }
    function k(w, W, E, O) {
      ...
      var G = O ? y : c,
        J = G(W).split(/\r|\n\r?/)
      e: for (
        var re = E.line, q = E.ch, I = w.lastLine() + 1 - J.length;
        re <= I;
        re++, q = 0
      ) {
        ...
        if (J.length == 1) {
          ...
          var E = d(D, Q, R, G) + q
          return {
            from: p(re, d(D, Q, R, G) + q),
            to: p(re, d(D, Q, R + J[0].length, G) + q),
          }
        } else {
          var V = Q.length - J[0].length
          if (Q.slice(V) != J[0]) continue e
          for (var x = 1; x < J.length - 1; x++)
            if (G(w.getLine(re + x)) != J[x]) continue e
          var K = w.getLine(re + J.length - 1),
            X = G(K),
            N = J[J.length - 1]
          if (X.slice(0, N.length) != N) continue e
          return {
            from: p(re, d(D, Q, V, G) + q),
            to: p(re + J.length - 1, d(K, X, N.length, G)),
          }
        }
      }
    }
    function z(w, W, E, O) {
      ...
      var G = O ? y : c,
        J = G(W).split(/\r|\n\r?/)
      e: for (
        var re = E.line, q = E.ch, I = w.firstLine() - 1 + J.length;
        re >= I;
        re--, q = -1
      ) {
        var D = w.getLine(re)
        ...
        var Q = G(D)
        if (J.length == 1) {
          var R = Q.lastIndexOf(J[0])
          if (R == -1) continue e
          return {
            from: p(re, d(D, Q, R, G)),
            to: p(re, d(D, Q, R + J[0].length, G)),
          }
        } else {
          var V = J[J.length - 1]
          if (Q.slice(0, V.length) != V) continue e
          for (var x = 1, E = re - J.length + 1; x < J.length - 1; x++)
            if (G(w.getLine(E + x)) != J[x]) continue e
          var K = w.getLine(re + 1 - J.length),
            X = G(K)
          if (X.slice(X.length - J[0].length) != J[0]) continue e
          return {
            from: p(re + 1 - J.length, d(K, X, K.length - J[0].length, G)),
            to: p(re, d(D, Q, V.length, G)),
          }
        }
      }
    }
    function M(w, W, E, O) {
      ...
      var G
      ;(typeof O == 'object' ? (G = O.caseFold) : ((G = O), (O = null)),
        typeof W == 'string'
          ? (G == null && (G = !1),
            (this.matches = function (J, re) {
              return (J ? z : k)(w, W, re, G)
            }))
          : ((W = C(W, 'gm')),
            !O || O.multiline !== !1
              ? (this.matches = function (J, re) {
    ...
    ;((M.prototype = {
      ...
      find: function (w) {
        ...
        if (
          ...
          w
            ? (W.ch--,
              W.ch < 0 &&
                (W.line--, (W.ch = (this.doc.getLine(W.line) || '').length)))
            : (W.ch++,
        ...
        var O = p(w ? this.doc.firstLine() : this.doc.lastLine() + 1, 0)
      ...
      o.defineExtension('selectMatches', function (w, W) {
        for (
          var E = [], O = this.getSearchCursor(w, this.getCursor('from'), W);
          O.findNext() && !(o.cmpPos(O.to(), this.getCursor('to')) > 0);
        )
...
var Vo = Ke((ws, Ss) => {
  ;(function (o) {
    ...
    function v(N, H, le, xe) {
      var F = N.indented
      return (
        N.context &&
          N.context.type == 'statement' &&
          le != 'statement' &&
          (F = N.context.indented),
        (N.context = new p(F, H, le, xe, null, N.context))
      )
    }
    function C(N) {
      var H = N.context.type
      return (
        (H == ')' || H == ']' || H == '}') && (N.indented = N.context.indented),
    ...
    function b(N, H, le) {
      if (
        ...
        H.prevToken == 'type' ||
        /\S(?:[^- ]>|[*\]])\s*$|\*$/.test(N.string.slice(0, le)) ||
        (H.typeAtEndOfLine && N.column() == N.indentation())
      )
        return !0
    }
    function S(N) {
      for (;;) {
        if (!N || N.type == 'top') return !0
        if (N.type == '}' && N.prev.info != 'namespace') return !1
        N = N.prev
      }
    }
    o.defineMode('clike', function (N, H) {
      var le = N.indentUnit,
        xe = H.statementIndentUnit || le,
        F = H.dontAlignCalls,
        L = H.keywords || {},
        de = H.types || {},
        ze = H.builtin || {},
      ...
      function te(we, Me) {
        ...
        var B = we.current()
        return h(L, B)
          ? (h(pe, B) && (ce = 'newstatement'),
            h(Ee, B) && (Be = !0),
            'keyword')
          : h(de, B)
            ? 'type'
            : h(ze, B) || (Z && Z(B))
              ? (h(pe, B) && (ce = 'newstatement'), 'builtin')
              : h(ge, B)
                ? 'atom'
                : 'variable'
      }
      function fe(we) {
        return function (Me, Le) {
          for (var $ = !1, B, se = !1; (B = Me.next()) != null; ) {
            if (B == we && !$) {
              se = !0
              break
            }
      ...
      return {
        ...
        token: function (we, Me) {
          ...
          if (
            ...
            var B = Oe.token(we, Me, $)
            B !== void 0 && ($ = B)
          }
          return (
            $ == 'def' && H.styleDefs === !1 && ($ = 'variable'),
            (Me.startOfLine = !1),
        ...
        indent: function (we, Me) {
          ...
          if (
            ...
            for (
              ;
              Le.type == 'statement' && H.dontIndentStatements.test(Le.info);
            )
              Le = Le.prev
          if (Oe.indent) {
          ...
          return Le.type == 'statement'
            ...
            : Le.align && (!F || Le.type != ')')
              ...
              : Le.type == ')' && !B
                ...
                : Le.indented +
                  (B ? 0 : le) +
                  (!B && De && !/^(?:case|default)\b/.test(Me) ? le : 0)
        },
        electricInput: je
          ? /^\s*(?:case .*?:|default:|\{\}?|\})$/
          : /^\s*[{}]$/,
    ...
    function s(N) {
      for (var H = {}, le = N.split(' '), xe = 0; xe < le.length; ++xe)
        H[le[xe]] = !0
      return H
    }
    function h(N, H) {
      return typeof N == 'function' ? N(H) : N.propertyIsEnumerable(H)
    }
    var g =
      ...
      k = s('SEL instancetype id Class Protocol BOOL')
    function z(N) {
      return h(d, N) || /.+_t$/.test(N)
    }
    function M(N) {
      return z(N) || h(k, N)
    }
    ...
    function E(N, H) {
      ...
      for (var le, xe = null; (le = N.peek()); ) {
        if (le == '\\' && N.match(/^.$/)) {
          xe = E
          break
        } else if (le == '/' && N.match(/^\/[\/\*]/, !1)) break
        N.next()
      }
      return ((H.tokenize = xe), 'meta')
    }
    function O(N, H) {
      return H.prevToken == 'type' ? 'type' : !1
    }
    function G(N) {
      return !N || N.length < 2 || N[0] != '_'
        ? !1
        : N[1] == '_' || N[1] !== N[1].toLowerCase()
    }
    function J(N) {
      return (N.eatWhile(/[\w\.']/), 'number')
    }
    function re(N, H) {
      if ((N.backUp(1), N.match(/^(?:R|u8R|uR|UR|LR)/))) {
        var le = N.match(/^"([^\s\\()]{0,16})\(/)
        return le
          ? ((H.cpp11RawStringDelim = le[1]), (H.tokenize = D), D(N, H))
          : !1
      }
      return N.match(/^(?:u8|u|U|L)/)
        ? N.match(/^["']/, !1)
          ? 'string'
          : !1
        : (N.next(), !1)
    ...
    function D(N, H) {
      var le = H.cpp11RawStringDelim.replace(/[^\w\s]/g, '\\$&'),
        xe = N.match(new RegExp('.*?\\)' + le + '"'))
      return (xe ? (H.tokenize = null) : N.skipToEnd(), 'string')
    }
    function Q(N, H) {
      typeof N == 'string' && (N = [N])
      var le = []
      ...
      ;(xe(H.keywords),
        ...
        xe(H.atoms),
        le.length &&
          ((H.helperType = N[0]), o.registerHelper('hintWords', N[0], le)))
      for (var F = 0; F < N.length; ++F) o.defineMIME(N[F], H)
    }
    ;(Q(['text/x-csrc', 'text/x-c', 'text/x-chdr'], {
      ...
      Q('text/x-java', {
        ...
        hooks: {
          '@': function (N) {
            return N.match('interface', !1)
              ? !1
              : (N.eatWhile(/[\w\$_]/), 'meta')
          },
          '"': function (N, H) {
            return N.match(/""$/) ? ((H.tokenize = R), H.tokenize(N, H)) : !1
          },
        },
    ...
    function V(N) {
      return function (H, le) {
        for (var xe; (xe = H.next()); )
          if (xe == '*' && H.eat('/'))
            if (N == 1) {
              le.tokenize = null
              break
            } else return ((le.tokenize = V(N - 1)), le.tokenize(H, le))
          else if (xe == '/' && H.eat('*'))
            return ((le.tokenize = V(N + 1)), le.tokenize(H, le))
        return 'comment'
      }
    }
    Q('text/x-scala', {
      ...
      hooks: {
        ...
        "'": function (N) {
          return N.match(/^(\\[^'\s]+|[^\\'])'/)
            ? 'string-2'
            : (N.eatWhile(/[\w\$_\xa1-\uffff]/), 'atom')
        },
        '=': function (N, H) {
          var le = H.context
          return le.type == '}' && le.align && N.eat('>')
            ? ((H.context = new p(
                le.indented,
                le.column,
                le.type,
        ...
        '/': function (N, H) {
          return N.eat('*') ? ((H.tokenize = V(1)), H.tokenize(N, H)) : !1
        },
      },
    ...
    function x(N) {
      return function (H, le) {
        for (var xe = !1, F, L = !1; !H.eol(); ) {
          ...
          ;((F = H.next()),
            !xe && F == '$' && H.match('{') && H.skipTo('}'),
            (xe = !xe && F == '\\' && !N))
        }
        return ((L || !N) && (le.tokenize = null), 'string')
      }
    }
    ;(Q('text/x-kotlin', {
      name: 'clike',
      ...
      hooks: {
        ...
        '"': function (N, H) {
          return ((H.tokenize = x(N.match('""'))), H.tokenize(N, H))
        },
        '/': function (N, H) {
          return N.eat('*') ? ((H.tokenize = V(1)), H.tokenize(N, H)) : !1
        },
        indent: function (N, H, le, xe) {
          var F = le && le.charAt(0)
          if ((N.prevToken == '}' || N.prevToken == ')') && le == '')
            return N.indented
          if (
            (N.prevToken == 'operator' && le != '}' && N.context.type != '}') ||
            (N.prevToken == 'variable' && F == '.') ||
            ((N.prevToken == '}' || N.prevToken == ')') && F == '.')
          )
            return xe * 2 + H.indented
          if (H.align && H.type == '}')
            return (
              H.indented + (N.context.type == (le || '').charAt(0) ? 0 : xe)
            )
        },
      },
      ...
      Q('text/x-objectivec++', {
        ...
        defKeywords: s(
          W + ' @interface @implementation @protocol @class class namespace'
        ),
        dontIndentStatements: /^@.*$|^template$/,
        typeFirstDefinitions: !0,
        atoms: s('YES NO NULL Nil nil true false nullptr'),
    ...
    function X(N) {
      return function (H, le) {
        for (var xe = !1, F, L = !1; !H.eol(); ) {
          if (!xe && H.match('"') && (N == 'single' || H.match('""'))) {
            L = !0
            break
          }
          if (!xe && H.match('``')) {
    ...
    Q('text/x-ceylon', {
      ...
      hooks: {
        ...
        '"': function (N, H) {
          return (
            (H.tokenize = X(N.match('""') ? 'triple' : 'single')),
            H.tokenize(N, H)
          )
        },
        '`': function (N, H) {
          return !K || !N.match('`')
            ? !1
            : ((H.tokenize = K), (K = null), H.tokenize(N, H))
        },
        "'": function (N) {
          return (N.eatWhile(/[\w\$_\xa1-\uffff]/), 'atom')
        },
        token: function (N, H, le) {
          if ((le == 'variable' || le == 'type') && H.prevToken == '.')
            return 'variable-2'
        },
      },
  ...
  ;(function (o) {
    ...
    o.defineMode('css', function (I, D) {
      ...
      var R = I.indentUnit,
        ...
        K = D.mediaTypes || {},
        X = D.mediaFeatures || {},
        N = D.mediaValueKeywords || {},
        H = D.propertyKeywords || {},
        le = D.nonStandardPropertyKeywords || {},
        xe = D.fontProperties || {},
        F = D.counterDescriptors || {},
        L = D.colorKeywords || {},
        de = D.valueKeywords || {},
        ze = D.allowNested,
        pe = D.lineComment,
        Ee = D.supportsAtComponent === !0,
        ge = I.highlightNonStandardPropertyKeywords !== !1,
        Oe,
        qe
      function Se(te, fe) {
        return ((Oe = fe), te)
      ...
      return (
        ...
        (Be.documentTypes = function (te, fe, oe) {
          return te == 'word' && x.hasOwnProperty(fe.current())
            ...
            : te == 'word'
              ? ((oe.stateArg == '@font-face' &&
                ...
                (oe.stateArg == '@counter-style' &&
                  !F.hasOwnProperty(fe.current().toLowerCase()))
                  ? (qe = 'error')
                  : (qe = 'property'),
                'maybeprop')
              : 'restricted_atBlock'
    ...
    function p(I) {
      for (var D = {}, Q = 0; Q < I.length; ++Q) D[I[Q].toLowerCase()] = !0
      return D
    }
    ...
    ;(o.defineMIME('text/css', {
      ...
      tokenHooks: {
        '/': function (I, D) {
          return I.eat('*') ? ((D.tokenize = q), q(I, D)) : !1
        },
      },
      name: 'css',
    }),
  ...
  ;(function (o) {
    ...
    ;(o.defineMode('xml', function (C, b) {
          ...
          return x.eat('!')
            ? x.eat('[')
              ...
              : x.match('--')
                ? X(z('comment', '-->'))
                : x.match('DOCTYPE', !0, !0)
                  ? (x.eatWhile(/[\w\._\-]/), X(M(1)))
                  : null
            : x.eat('?')
              ? (x.eatWhile(/[\w\._\-]/),
                (K.tokenize = z('meta', '?>')),
                'meta')
              : ((T = x.eat('/') ? 'closeTag' : 'openTag'),
                (K.tokenize = d),
                'tag bracket')
        if (N == '&') {
          var H
          return (
            x.eat('#')
              ? x.eat('x')
                ? (H = x.eatWhile(/[a-fA-F\d]/) && x.eat(';'))
                : (H = x.eatWhile(/[\d]/) && x.eat(';'))
              : (H = x.eatWhile(/[\w\.\-:]/) && x.eat(';')),
            H ? 'atom' : 'error'
          )
      ...
      function d(x, K) {
        ...
        if (X == '<') {
          ;((K.tokenize = c), (K.state = G), (K.tagName = K.tagStart = null))
          var N = K.tokenize(x, K)
          return N ? N + ' tag error' : 'tag error'
        } else
          return /[\'\"]/.test(X)
            ? ((K.tokenize = k(X)),
              (K.stringStartCol = x.column()),
              K.tokenize(x, K))
            : (x.match(/^[^\s\u00a0=<>\"\']*[^\s\u00a0=<>\"\'\/]/), 'word')
      }
      function k(x) {
      ...
      function M(x) {
        return function (K, X) {
          for (var N; (N = K.next()) != null; ) {
            if (N == '<') return ((X.tokenize = M(x + 1)), X.tokenize(K, X))
            if (N == '>')
              if (x == 1) {
                X.tokenize = c
                break
              } else return ((X.tokenize = M(x - 1)), X.tokenize(K, X))
          }
          return 'meta'
        }
      }
        ...
        for (var X; ; ) {
          if (
            ...
            !s.contextGrabbers.hasOwnProperty(w(X)) ||
              !s.contextGrabbers[w(X)].hasOwnProperty(w(K)))
          )
            return
          E(x)
        }
      ...
      function J(x, K, X) {
        return x == 'word'
          ? ((X.tagName = K.current()), (y = 'tag'), D)
          : s.allowMissingTagName && x == 'endTag'
            ? ((y = 'tag bracket'), D(x, K, X))
            : ((y = 'error'), J)
      }
      function re(x, K, X) {
        if (x == 'word') {
          ...
          return (
            X.context &&
              ...
              E(X),
            (X.context && X.context.tagName == N) || s.matchClosing === !1
              ? ((y = 'tag'), q)
              : ((y = 'tag error'), I)
          )
        } else
          return s.allowMissingTagName && x == 'endTag'
            ? ((y = 'tag bracket'), q(x, K, X))
            : ((y = 'error'), I)
      }
      function q(x, K, X) {
        return x != 'endTag' ? ((y = 'error'), q) : (E(X), G)
      }
      function I(x, K, X) {
        return ((y = 'error'), q(x, K, X))
      }
      function D(x, K, X) {
        if (x == 'word') return ((y = 'attribute'), Q)
        if (x == 'endTag' || x == 'selfcloseTag') {
          var N = X.tagName,
            H = X.tagStart
          return (
            (X.tagName = X.tagStart = null),
            x == 'selfcloseTag' || s.autoSelfClosers.hasOwnProperty(w(N))
              ? O(X, N)
              : (O(X, N), (X.context = new W(X, N, H == X.indented))),
            G
          )
        }
        return ((y = 'error'), D)
      ...
      function Q(x, K, X) {
        return x == 'equals' ? R : (s.allowMissing || (y = 'error'), D(x, K, X))
      }
      function R(x, K, X) {
        return x == 'string'
          ? V
      ...
      return {
        ...
        token: function (x, K) {
          if (
            (!K.tagName && x.sol() && (K.indented = x.indentation()),
            x.eatSpace())
          )
            return null
          T = null
          var X = K.tokenize(x, K)
          return (
            (X || T) &&
              X != 'comment' &&
              ((y = null),
              (K.state = K.state(T || X, x, K)),
              y && (X = y == 'error' ? X + ' error' : y)),
            X
          )
        },
        indent: function (x, K, X) {
          var N = x.context
          if (x.tokenize.isInAttribute)
            return x.tagStart == x.indented
              ? x.stringStartCol + 1
              : x.indented + S
          if (N && N.noIndent) return o.Pass
          if (x.tokenize != d && x.tokenize != c)
            return X ? X.match(/^(\s*)/)[0].length : 0
          if (x.tagName)
            return s.multilineTagIndentPastTag !== !1
              ? x.tagStart + x.tagName.length + 2
              : x.tagStart + S * (s.multilineTagIndentFactor || 1)
          ...
          if (H && H[1])
            for (; N; )
              if (N.tagName == H[2]) {
                N = N.prev
                break
              } else if (s.implicitlyClosed.hasOwnProperty(w(N.tagName)))
                N = N.prev
              else break
          else if (H)
            for (; N; ) {
              var le = s.contextGrabbers[w(N.tagName)]
              if (le && le.hasOwnProperty(w(H[2]))) N = N.prev
              else break
            }
          for (; N && N.prev && !N.startOfLine; ) N = N.prev
          return N ? N.indent + S : x.baseIndent || 0
        },
        electricInput: /<\/[\s\w:]+>$/,
        blockCommentStart: '<!--',
        blockCommentEnd: '-->',
        ...
        xmlCurrentTag: function (x) {
          return x.tagName
            ? { name: x.tagName, close: x.type == 'closeTag' }
            : null
        },
        xmlCurrentContext: function (x) {
          for (var K = [], X = x.context; X; X = X.prev) K.push(X.tagName)
          return K.reverse()
        },
      }
    }),
...
var vn = Ke((Is, Ns) => {
  ;(function (o) {
    ...
    ;(o.defineMode('javascript', function (p, v) {
      ...
      function k(_) {
        for (var P = !1, ae, he = !1; (ae = _.next()) != null; ) {
          if (!P) {
            if (ae == '/' && !he) return
            ae == '[' ? (he = !0) : he && ae == ']' && (he = !1)
          }
      ...
      function W(_, P) {
        ...
        if (ae == '`') return ((P.tokenize = G), G(_, P))
        if (ae == '#' && _.peek() == '!')
          return (_.skipToEnd(), w('meta', 'meta'))
        if (ae == '#' && _.eatWhile(T)) return w('variable', 'property')
        if (
          (ae == '<' && _.match('!--')) ||
        ...
        if (T.test(ae)) {
          ...
          var he = _.current()
          if (P.lastType != '.') {
            if (y.propertyIsEnumerable(he)) {
              var ne = y[he]
              return w(ne.type, ne.style, he)
            }
            if (
              he == 'async' &&
              _.match(/^(\s|\/\*([^*]|\*(?!\/))*?\*\/)*[\[\(\w]/, !1)
            )
              return w('async', 'keyword', he)
          }
          return w('variable', 'variable', he)
        }
      }
      function E(_) {
        return function (P, ae) {
          ...
          for (; (ne = P.next()) != null && !(ne == _ && !he); )
            he = !he && ne == '\\'
          return (he || (ae.tokenize = W), w('string', 'string'))
        }
      }
      function O(_, P) {
        for (var ae = !1, he; (he = _.next()); ) {
          if (he == '/' && ae) {
            P.tokenize = W
            break
          }
      ...
      function G(_, P) {
        for (var ae = !1, he; (he = _.next()) != null; ) {
          if (!ae && (he == '`' || (he == '$' && _.eat('{')))) {
            P.tokenize = W
            break
          }
      ...
      function D(_, P) {
        ...
        for (var he = _.context; he; he = he.prev)
          for (var ae = he.vars; ae; ae = ae.next) if (ae.name == P) return !0
      }
      function Q(_, P, ae, he, ne) {
        var ye = _.cc
        for (
          R.state = _,
            R.stream = ne,
      ...
      var R = { state: null, column: null, marked: null, cc: null }
      function V() {
        for (var _ = arguments.length - 1; _ >= 0; _--) R.cc.push(arguments[_])
      }
      function x() {
        ...
        if (((R.marked = 'def'), !!h)) {
          if (P.context) {
            if (P.lexical.info == 'var' && P.context && P.context.block) {
              var ae = N(_, P.context)
              if (ae != null) {
                P.context = ae
                return
              }
            } else if (!K(_, P.localVars)) {
              P.localVars = new xe(_, P.localVars)
              return
            }
          }
          v.globalVars &&
            !K(_, P.globalVars) &&
            (P.globalVars = new xe(_, P.globalVars))
        }
      }
      function N(_, P) {
        if (P)
          if (P.block) {
            var ae = N(_, P.prev)
            return ae ? (ae == P.prev ? P : new le(ae, P.vars, !0)) : null
          } else return K(_, P.vars) ? P : new le(P.prev, new xe(_, P.vars), !1)
        else return null
      }
      function H(_) {
        return (
      ...
      var F = new xe('this', new xe('arguments', null))
      function L() {
        ;((R.state.context = new le(R.state.context, R.state.localVars, !1)),
          (R.state.localVars = F))
      }
      function de() {
        ;((R.state.context = new le(R.state.context, R.state.localVars, !0)),
          (R.state.localVars = null))
      }
      L.lex = de.lex = !0
      function ze() {
        ;((R.state.localVars = R.state.context.vars),
          (R.state.context = R.state.context.prev))
      }
      ze.lex = !0
      function pe(_, P) {
        var ae = function () {
          ...
          if (he.lexical.type == 'stat') ne = he.lexical.indented
            ...
            for (
              ...
              ne = ye.indented
          he.lexical = new I(ne, R.stream.column(), _, null, he.lexical, P)
        }
        return ((ae.lex = !0), ae)
      }
      function Ee() {
                ...
                : _ == 'debugger'
                  ...
                  : _ == '{'
                    ...
                    : _ == ';'
                      ? x()
                      : _ == 'if'
                        ? (R.state.lexical.info == 'else' &&
                            R.state.cc[R.state.cc.length - 1] == Ee &&
                            R.state.cc.pop()(),
                          x(pe('form'), Ze, Oe, Ee, Br))
                        : _ == 'function'
                          ? x(Bt)
                          : _ == 'for'
                            ? x(pe('form'), de, ei, Oe, ze, Ee)
                            : _ == 'class' || (g && P == 'interface')
                              ? ((R.marked = 'keyword'),
                                x(pe('form', _ == 'class' ? _ : P), Wr, Ee))
                              : _ == 'variable'
                                ? g && P == 'declare'
                                  ? ((R.marked = 'keyword'), x(Oe))
                                  : g &&
                                      (P == 'module' ||
                                        P == 'enum' ||
                                        P == 'type') &&
                                      R.stream.match(/^\s*\w/, !1)
                                    ? ((R.marked = 'keyword'),
                                      P == 'enum'
                                        ? x(Ae)
                                        : P == 'type'
                                          ? x(ti, ge('operator'), Pe, ge(';'))
                                          : x(
                                              pe('form'),
                                              Ct,
                                              ge('{'),
      ...
      function Ze(_) {
        return _ != '(' ? V() : x(pe(')'), Je, ge(')'), Ee)
      }
      function ke(_, P, ae) {
        if (R.state.fatArrowAt == R.stream.start) {
          var he = ae ? Be : ce
          if (_ == '(') return x(L, pe(')'), B($t, ')'), Ee, ge('=>'), he, ze)
          if (_ == 'variable') return V(L, Ct, ge('=>'), he, ze)
        }
        var ne = ae ? Ge : He
        return q.hasOwnProperty(_)
          ...
          : _ == 'function'
            ? x(Bt, ne)
            : _ == 'class' || (g && P == 'interface')
              ? ((R.marked = 'keyword'), x(pe('form'), to, Ee))
              : _ == 'keyword c' || _ == 'async'
                ? x(ae ? je : Se)
                : _ == '('
                  ? x(pe(')'), Je, ge(')'), Ee, ne)
      ...
      function He(_, P) {
        return _ == ',' ? x(Je) : Ge(_, P, !1)
      }
      function Ge(_, P, ae) {
        var he = ae == !1 ? He : Ge,
          ne = ae == !1 ? Se : je
        if (_ == '=>') return x(L, ae ? Be : ce, ze)
        if (_ == 'operator')
          return /\+\+|--/.test(P) || (g && P == '!')
            ? x(he)
            : g && P == '<' && R.stream.match(/^([^<>]|<[^<>]*>)*>\s*\(/, !1)
              ? x(pe('>'), B(Pe, '>'), Ee, he)
              : P == '?'
                ? x(Se, ge(':'), ne)
                : x(ne)
        if (_ == 'quasi') return V(U, he)
        if (_ != ';') {
          if (_ == '(') return se(je, ')', 'call', he)
          if (_ == '.') return x(we, he)
          if (_ == '[') return x(pe(']'), Je, ge(']'), Ee, he)
          if (g && P == 'as') return ((R.marked = 'keyword'), x(Pe, he))
          if (_ == 'regexp')
            return (
              (R.state.lastType = R.marked = 'operator'),
              R.stream.backUp(R.stream.pos - R.stream.start - 1),
              x(ne)
            )
        }
      }
      ...
      function Z(_) {
        if (_ == '}')
          return ((R.marked = 'string-2'), (R.state.tokenize = G), x(U))
      }
      function ce(_) {
        return (re(R.stream, R.state), V(_ == '{' ? Oe : Se))
      }
      function Be(_) {
        return (re(R.stream, R.state), V(_ == '{' ? Oe : je))
      }
      function te(_) {
        return function (P) {
          return P == '.'
      ...
      function fe(_, P) {
        if (P == 'target') return ((R.marked = 'keyword'), x(He))
      }
      function oe(_, P) {
        if (P == 'target') return ((R.marked = 'keyword'), x(Ge))
      }
      function Ue(_) {
        return _ == ':' ? x(Ee, Oe) : V(He, ge(';'), Ee)
      }
      function we(_) {
        if (_ == 'variable') return ((R.marked = 'property'), x())
      }
      function Me(_, P) {
        if (_ == 'async') return ((R.marked = 'property'), x(Me))
        if (_ == 'variable' || R.style == 'keyword') {
          if (((R.marked = 'property'), P == 'get' || P == 'set')) return x(Le)
          var ae
          return (
            g &&
              R.state.fatArrowAt == R.stream.start &&
              (ae = R.stream.match(/^\s*:\s*/, !1)) &&
              (R.state.fatArrowAt = R.stream.pos + ae[0].length),
            x($)
          )
        } else {
          if (_ == 'number' || _ == 'string')
            return ((R.marked = S ? 'property' : R.style + ' property'), x($))
          if (_ == 'jsonld-keyword') return x($)
          if (g && H(P)) return ((R.marked = 'keyword'), x(Me))
          if (_ == '[') return x(Se, nt, ge(']'), $)
          if (_ == 'spread') return x(je, $)
          if (P == '*') return ((R.marked = 'keyword'), x(Me))
          if (_ == ':') return V($)
        }
      }
      function Le(_) {
        return _ != 'variable' ? V($) : ((R.marked = 'property'), x(Bt))
      }
      function $(_) {
        if (_ == ':') return x(je)
        if (_ == '(') return V(Bt)
      ...
      function B(_, P, ae) {
        ...
        return function (ne, ye) {
          return ne == P || ye == P ? x() : V(_, he)
        }
      }
      function se(_, P, ae) {
        for (var he = 3; he < arguments.length; he++) R.cc.push(arguments[he])
        return x(pe(P, ae), B(_, P), Ee)
      }
      function De(_) {
        return _ == '}' ? x() : V(Oe, De)
      }
      ...
      function dt(_, P) {
        if (g && (_ == ':' || P == 'in')) return x(Pe)
      }
      function Pt(_) {
        if (g && _ == ':')
          return R.stream.match(/^\s*\w+\s+is\b/, !1) ? x(Se, Ft, Pe) : x(Pe)
      }
      function Ft(_, P) {
        if (P == 'is') return ((R.marked = 'keyword'), x())
      }
      function Pe(_, P) {
        if (P == 'keyof' || P == 'typeof' || P == 'infer' || P == 'readonly')
          return ((R.marked = 'keyword'), x(P == 'typeof' ? je : Pe))
        if (_ == 'variable' || P == 'void') return ((R.marked = 'type'), x(Ht))
        if (P == '|' || P == '&') return x(Pe)
        if (_ == 'string' || _ == 'number' || _ == 'atom') return x(Ht)
        if (_ == '[') return x(pe(']'), B(Pe, ']', ','), Ee, Ht)
        if (_ == '{') return x(pe('}'), Ie, Ee, Ht)
        if (_ == '(') return x(B(ot, ')'), xt, Ht)
        if (_ == '<') return x(B(Pe, '>'), Pe)
        if (_ == 'quasi') return V(_t, Ht)
      }
      function xt(_) {
        if (_ == '=>') return x(Pe)
      }
      ...
      function nr(_, P) {
        if (_ == 'variable' || R.style == 'keyword')
          return ((R.marked = 'property'), x(nr))
        if (P == '?' || _ == 'number' || _ == 'string') return x(nr)
        if (_ == ':') return x(Pe)
        if (_ == '[') return x(ge('variable'), dt, ge(']'), nr)
        if (_ == '(') return V(hr, nr)
        if (!_.match(/[;\}\)\],]/)) return x()
      }
      function _t(_, P) {
      ...
      function it(_) {
        if (_ == '}')
          return ((R.marked = 'string-2'), (R.state.tokenize = G), x(_t))
      }
      function ot(_, P) {
        return (_ == 'variable' && R.stream.match(/^\s*[?:]/, !1)) || P == '?'
          ? x(ot)
          : _ == ':'
            ? x(Pe)
            : _ == 'spread'
      ...
      function Ht(_, P) {
        if (P == '<') return x(pe('>'), B(Pe, '>'), Ee, Ht)
        if (P == '|' || _ == '.' || P == '&') return x(Pe)
        if (_ == '[') return x(Pe, ge(']'), Ht)
        if (P == 'extends' || P == 'implements')
          return ((R.marked = 'keyword'), x(Pe))
        if (P == '?') return x(Pe, ge(':'), Pe)
      }
      function It(_, P) {
        if (P == '<') return x(pe('>'), B(Pe, '>'), Ee, Ht)
      }
      ...
      function Hr(_, P) {
        return P == 'enum' ? ((R.marked = 'keyword'), x(Ae)) : V(Ct, nt, Ut, eo)
      }
      function Ct(_, P) {
        if (g && H(P)) return ((R.marked = 'keyword'), x(Ct))
        if (_ == 'variable') return (X(P), x())
        if (_ == 'spread') return x(Ct)
        if (_ == '[') return se(yn, ']')
        if (_ == '{') return se(dr, '}')
      }
      function dr(_, P) {
        return _ == 'variable' && !R.stream.match(/^\s*:/, !1)
          ? (X(P), x(Ut))
          : (_ == 'variable' && (R.marked = 'property'),
            _ == 'spread'
              ? x(Ct)
              : _ == '}'
                ? V()
      ...
      function Br(_, P) {
        if (_ == 'keyword b' && P == 'else')
          return x(pe('form', 'else'), Oe, Ee)
      }
      function ei(_, P) {
        if (P == 'await') return x(ei)
        if (_ == '(') return x(pe(')'), xn, Ee)
      }
      function xn(_) {
        return _ == 'var' ? x(Hr, pr) : _ == 'variable' ? x(pr) : V(pr)
      }
      function pr(_, P) {
        return _ == ')'
          ? x()
          : _ == ';'
            ? x(pr)
            : P == 'in' || P == 'of'
              ? ((R.marked = 'keyword'), x(Se, pr))
              : V(Se, pr)
      }
      function Bt(_, P) {
        if (P == '*') return ((R.marked = 'keyword'), x(Bt))
        if (_ == 'variable') return (X(P), x(Bt))
        if (_ == '(') return x(L, pe(')'), B($t, ')'), Ee, Pt, Oe, ze)
        if (g && P == '<') return x(pe('>'), B(Wt, '>'), Ee, Bt)
      }
      function hr(_, P) {
        if (P == '*') return ((R.marked = 'keyword'), x(hr))
        if (_ == 'variable') return (X(P), x(hr))
        if (_ == '(') return x(L, pe(')'), B($t, ')'), Ee, Pt, ze)
        if (g && P == '<') return x(pe('>'), B(Wt, '>'), Ee, hr)
      }
      function ti(_, P) {
        if (_ == 'keyword' || _ == 'variable')
          return ((R.marked = 'type'), x(ti))
        if (P == '<') return x(pe('>'), B(Wt, '>'), Ee)
      }
      function $t(_, P) {
        return (
          P == '@' && x(Se, $t),
      ...
      function Wr(_, P) {
        if (_ == 'variable') return (X(P), x(Kt))
      }
      function Kt(_, P) {
        if (P == '<') return x(pe('>'), B(Wt, '>'), Ee, Kt)
        if (P == 'extends' || P == 'implements' || (g && _ == ','))
          return (
            P == 'implements' && (R.marked = 'keyword'),
            x(g ? Pe : Se, Kt)
          )
        if (_ == '{') return x(pe('}'), Gt, Ee)
      }
      function Gt(_, P) {
        if (
          _ == 'async' ||
          (_ == 'variable' &&
            (P == 'static' || P == 'get' || P == 'set' || (g && H(P))) &&
            R.stream.match(/^\s+#?[\w$\xa1-\uffff]/, !1))
        )
          return ((R.marked = 'keyword'), x(Gt))
        if (_ == 'variable' || R.style == 'keyword')
          return ((R.marked = 'property'), x(Cr, Gt))
        if (_ == 'number' || _ == 'string') return x(Cr, Gt)
        if (_ == '[') return x(Se, nt, ge(']'), Cr, Gt)
        if (P == '*') return ((R.marked = 'keyword'), x(Gt))
      ...
      function Cr(_, P) {
        ...
        if (_ == ':') return x(Pe, Ut)
        if (P == '=') return x(je)
        var ae = R.state.lexical.prev,
          he = ae && ae.info == 'interface'
        return V(he ? hr : Bt)
      }
      function Ur(_, P) {
        return P == '*'
          ? ((R.marked = 'keyword'), x(Gr, ge(';')))
          : P == 'default'
            ? ((R.marked = 'keyword'), x(Se, ge(';')))
            : _ == '{'
              ? x(B($r, '}'), Gr, ge(';'))
              : V(Oe)
      }
      function $r(_, P) {
        if (P == 'as') return ((R.marked = 'keyword'), x(ge('variable')))
        if (_ == 'variable') return V(je, $r)
      }
      function gr(_) {
        return _ == 'string'
          ? x()
      ...
      function Kr(_, P) {
        return _ == '{'
          ? se(Kr, '}')
          : (_ == 'variable' && X(P), P == '*' && (R.marked = 'keyword'), x(_n))
      }
      function Vt(_) {
        if (_ == ',') return x(Kr, Vt)
      }
      function _n(_, P) {
        if (P == 'as') return ((R.marked = 'keyword'), x(Kr))
      }
      function Gr(_, P) {
        if (P == 'from') return ((R.marked = 'keyword'), x(Se))
      }
      function at(_) {
        return _ == ']' ? x() : V(B(je, ']'))
      }
      function Ae() {
        return V(pe('form'), Ct, ge('{'), pe('}'), B(ir, '}'), Ee, Ee)
      }
      function ir() {
        return V(Ct, Ut)
      }
      ...
      return {
        ...
        token: function (_, P) {
          ...
          return z == 'comment'
            ? ae
            : ((P.lastType =
                z == 'operator' && (M == '++' || M == '--') ? 'incdec' : z),
              Q(P, ae, z, M, _))
        },
        indent: function (_, P) {
          if (_.tokenize == O || _.tokenize == G) return o.Pass
          ...
          return pt == 'vardef'
            ...
            : pt == 'form' && ae == '{'
              ...
              : pt == 'form'
                ? he.indented + C
                : pt == 'stat'
                  ? he.indented + (kn(_, P) ? b || C : 0)
                  : he.info == 'switch' && !Et && v.doubleIndentSwitch != !1
                    ? he.indented + (/^(?:case|default)\b/.test(P) ? C : 2 * C)
                    : he.align
                      ? he.column + (Et ? 0 : 1)
                      : he.indented + (Et ? 0 : C)
        },
...
var Qn = Ke((Os, Ps) => {
  ;(function (o) {
    ...
    function v(T, y, c) {
      ...
      return (
        k > -1
          ? T.backUp(d.length - k)
          : d.match(/<\/?$/) &&
            (T.backUp(d.length), T.match(y, !1) || T.match(d)),
        c
      )
    }
    var C = {}
    ...
    function s(T, y) {
      return new RegExp((y ? '^' : '') + '</\\s*' + T + '\\s*>', 'i')
    }
    function h(T, y) {
      for (var c in T)
        for (
          var d = y[c] || (y[c] = []), k = T[c], z = k.length - 1;
          z >= 0;
          z--
        )
          d.unshift(k[z])
    ...
    function g(T, y) {
      for (var c = 0; c < T.length; c++) {
        var d = T[c]
        if (!d[0] || d[1].test(S(y, d[0]))) return d[2]
      }
    }
    ;(o.defineMode(
      'htmlmixed',
      function (T, y) {
        var c = o.getMode(T, {
            name: 'xml',
            htmlMode: !0,
            multilineTagIndentFactor: y.multilineTagIndentFactor,
            multilineTagIndentPastTag: y.multilineTagIndentPastTag,
            allowMissingTagName: y.allowMissingTagName,
          }),
          d = {},
          k = y && y.tags,
          z = y && y.scriptTypes
        ...
        function w(W, E) {
          var O = c.token(W, E.htmlState),
            G = /\btag\b/.test(O),
            J
          if (
            G &&
            !/[<>\s\/]/.test(W.current()) &&
            (J = E.htmlState.tagName && E.htmlState.tagName.toLowerCase()) &&
            d.hasOwnProperty(J)
          )
            E.inTag = J + ' '
          else if (E.inTag && G && />$/.test(W.current())) {
            ...
            var q = W.current() == '>' && g(d[re[1]], re[2]),
              ...
              D = s(re[1], !0),
              Q = s(re[1], !1)
            ;((E.token = function (R, V) {
              return R.match(D, !1)
                ? ((V.token = w), (V.localState = V.localMode = null), null)
                : v(R, Q, V.localMode.token(R, V.localState))
            }),
              (E.localMode = I),
              (E.localState = o.startState(I, c.indent(E.htmlState, '', ''))))
          } else
            E.inTag && ((E.inTag += W.current()), W.eol() && (E.inTag += ' '))
          return O
        }
        return {
          startState: function () {
          ...
          indent: function (W, E, O) {
            return !W.localMode || /^\s*<\//.test(E)
              ? c.indent(W.htmlState, E, O)
              : W.localMode.indent
                ? W.localMode.indent(W.localState, E, O)
                : o.Pass
          },
...
var Hs = Ke((js, Rs) => {
  ;(function (o) {
    ...
    ;(o.defineMode('django:inner', function () {
      ...
      function s(c, d) {
        return function (k, z) {
          if (!z.escapeNext && k.eat(c)) z.tokenize = d
          else {
      ...
      function g(c, d) {
        ...
        var k = c.match(p)
        return k
          ? (k[0] == 'comment' && (d.blockCommentTag = !0), 'keyword')
          : c.match(/\b(\w+)\b/)
            ? ((d.waitDot = !0), (d.waitPipe = !0), 'variable')
            : c.match('%}')
              ? ((d.waitProperty = null),
                ...
                (d.waitPipe = null),
                d.blockCommentTag
                  ? ((d.blockCommentTag = !1), (d.tokenize = y))
                  : (d.tokenize = S),
                'tag')
              : (c.next(), 'null')
      }
...
var Di = Ke((Bs, Ws) => {
  ;(function (o) {
    ...
    'use strict'
    ;((o.defineSimpleMode = function (y, c) {
      o.defineMode(y, function (d) {
        return o.simpleMode(d, c)
      })
    }),
      (o.simpleMode = function (y, c) {
        p(c, 'start')
        var d = {},
          k = c.meta || {},
          z = !1
        for (var M in c)
          if (M != k && c.hasOwnProperty(M))
            for (var w = (d[M] = []), W = c[M], E = 0; E < W.length; E++) {
              var O = W[E]
              ;(w.push(new b(O, c)), (O.indent || O.dedent) && (z = !0))
            }
        var G = {
          startState: function () {
            return {
          ...
          copyState: function (re) {
            ...
            ;(re.localState &&
              (q.localState = o.copyState(re.local.mode, re.localState)),
              re.stack && (q.stack = re.stack.slice(0)))
            for (var I = re.persistentStates; I; I = I.next)
              q.persistentStates = {
                mode: I.mode,
                spec: I.spec,
                state:
                  I.state == re.localState
                    ? q.localState
                    : o.copyState(I.mode, I.state),
        ...
        if (k) for (var J in k) k.hasOwnProperty(J) && (G[J] = k[J])
        return G
      }))
    function p(y, c) {
    ...
    function v(y, c) {
      ...
      return (
        y instanceof RegExp
          ? (y.ignoreCase && (d = 'i'), y.unicode && (d += 'u'), (y = y.source))
          : (y = String(y)),
        new RegExp((c === !1 ? '' : '^') + '(?:' + y + ')', d)
      )
    }
    function C(y) {
      if (!y) return null
      if (y.apply) return y
      if (typeof y == 'string') return y.replace(/\./g, ' ')
      for (var c = [], d = 0; d < y.length; d++)
        c.push(y[d] && y[d].replace(/\./g, ' '))
      return c
    }
    function b(y, c) {
      ;((y.next || y.push) && p(c, y.next || y.push),
        (this.regex = v(y.regex)),
        (this.token = C(y.token)),
        (this.data = y))
    }
    function S(y, c) {
      return function (d, k) {
        if (k.pending) {
          var z = k.pending.shift()
          return (
        ...
        if (k.local)
          if (k.local.end && d.match(k.local.end)) {
            var M = k.local.endToken || null
            return ((k.local = k.localState = null), M)
          } else {
            var M = k.local.mode.token(d, k.localState),
              w
            return (
              k.local.endScan &&
                (w = k.local.endScan.exec(d.current())) &&
                (d.pos = d.start + w.index),
              M
            )
          }
        for (var W = y[k.state], E = 0; E < W.length; E++) {
          var O = W[E],
            G = (!O.data.sol || d.sol()) && d.match(O.regex)
          if (G) {
            ;(O.data.next
              ? (k.state = O.data.next)
              : O.data.push
                ...
                : O.data.pop &&
                  ...
                  k.stack.length &&
                  (k.state = k.stack.pop()),
              O.data.mode && h(c, k, O.data.mode, O.token),
              O.data.indent && k.indent.push(d.indentation() + c.indentUnit),
              O.data.dedent && k.indent.pop())
            var J = O.token
            if (
              (J && J.apply && (J = J(G)),
              G.length > 2 && O.token && typeof O.token != 'string')
            ) {
              for (var re = 2; re < G.length; re++)
                G[re] &&
                  (k.pending || (k.pending = [])).push({
                    text: G[re],
                    token: O.token[re - 1],
                  })
              return (d.backUp(G[0].length - (G[1] ? G[1].length : 0)), J[0])
            } else return J && J.join ? J[0] : J
          }
        }
        return (d.next(), null)
      }
    ...
    function s(y, c) {
      if (y === c) return !0
      if (!y || typeof y != 'object' || !c || typeof c != 'object') return !1
      var d = 0
      for (var k in y)
        if (y.hasOwnProperty(k)) {
          if (!c.hasOwnProperty(k) || !s(y[k], c[k])) return !1
          d++
        }
      for (var k in c) c.hasOwnProperty(k) && d--
      return d == 0
    }
    function h(y, c, d, k) {
      var z
      ...
      var w = z ? z.mode : d.mode || o.getMode(y, d.spec),
    ...
    function g(y, c) {
      for (var d = 0; d < c.length; d++) if (c[d] === y) return !0
    }
    function T(y, c) {
      return function (d, k, z) {
        if (d.local && d.local.mode.indent)
          return d.local.mode.indent(d.localState, k, z)
        if (
          d.indent == null ||
          d.local ||
        ...
        e: for (;;) {
          for (var W = 0; W < w.length; W++) {
            ...
            if (E.data.dedent && E.data.dedentIfLineStart !== !1) {
              var O = E.regex.exec(k)
              if (O && O[0]) {
                ;(M--,
                  (E.next || E.push) && (w = y[E.next || E.push]),
                  (k = k.slice(O[0].length)))
                continue e
              }
            }
          }
  ...
  ;(function (o) {
    ...
    ;(o.defineMode(
      ...
      function (p, v) {
        ...
        function S(F) {
          if (o.findModeByName) {
            var L = o.findModeByName(F)
            L && (F = L.mime || L.mimes[0])
          }
          var de = o.getMode(p, F)
        ...
        var g = /^([*\-_])(?:\s*\1){2,}\s*$/,
          ...
          W = '    '
        function E(F, L, de) {
          return ((L.f = L.inline = de), de(F, L))
        }
        function O(F, L, de) {
          return ((L.f = L.block = de), de(F, L))
        }
        function G(F) {
          return !F || !/\S/.test(F.string)
        }
        function J(F) {
          if (
            ((F.linkTitle = !1),
            ...
            var L = b
            if (!L) {
              var de = o.innerMode(C, F.htmlState)
              L =
                de.mode.name == 'xml' &&
            ...
            L && ((F.f = R), (F.block = re), (F.htmlState = null))
          }
          return (
            (F.trailingSpace = 0),
            (F.trailingSpaceNewLine = !1),
            (F.prevLine = F.thisLine),
            (F.thisLine = { stream: null }),
            null
          )
        }
        function re(F, L) {
          var de = F.column() === L.indentation,
            ze = G(L.prevLine.stream),
            pe = L.indentedCode,
            Ee = L.prevLine.hr,
            ge = L.list !== !1,
          ...
          var Se =
            ...
            je =
              (L.list === !1 || Ee || ze) && L.indentation <= Oe && F.match(g),
            Ze = null
          if (
            L.indentationDiff >= 4 &&
            (pe || L.prevLine.fencedCodeEnd || L.prevLine.header || ze)
          )
            return (F.skipToEnd(), (L.indentedCode = !0), s.code)
          ...
          if (
            ...
            var ke = Ze[1] ? 'ol' : 'ul'
            return (
              (L.indentation = qe + F.current().length),
              (L.list = !0),
              (L.quote = 0),
              ...
              (L.code = !1),
              (L.strikethrough = !1),
              v.taskLists && F.match(y, !1) && (L.taskList = !0),
              (L.f = L.inline),
              v.highlightFormatting && (L.formatting = ['list', 'list-' + ke]),
              D(L)
            )
          } else {
            if (de && L.indentation <= Oe && (Ze = F.match(z, !0)))
              return (
                (L.quote = 0),
            ...
            if (je)
              return (F.skipToEnd(), (L.hr = !0), (L.thisLine.hr = !0), s.hr)
            if (F.peek() === '[') return E(F, L, N)
          }
          return E(F, L, L.inline)
        }
        function q(F, L) {
          var de = C.token(F, L.htmlState)
          if (!b) {
            ...
            ;((ze.mode.name == 'xml' &&
              ...
              (L.md_inside && F.current().indexOf('>') > -1)) &&
              ((L.f = R), (L.block = re), (L.htmlState = null))
          }
          return de
        }
        function I(F, L) {
          ...
          if (
            ...
            return L.localMode
              ? L.localMode.token(F, L.localState)
              : (F.skipToEnd(), s.code)
        }
        function D(F) {
          var L = []
          if (F.formatting) {
            ;(L.push(s.formatting),
              typeof F.formatting == 'string' &&
                (F.formatting = [F.formatting]))
            for (var de = 0; de < F.formatting.length; de++)
              (L.push(s.formatting + '-' + F.formatting[de]),
                F.formatting[de] === 'header' &&
                  L.push(
                    s.formatting + '-' + F.formatting[de] + '-' + F.header
                  ),
                F.formatting[de] === 'quote' &&
                  (!v.maxBlockquoteDepth || v.maxBlockquoteDepth >= F.quote
                    ? L.push(
                        s.formatting + '-' + F.formatting[de] + '-' + F.quote
                      )
                    : L.push('error')))
          }
          if (F.taskOpen) return (L.push('meta'), L.length ? L.join(' ') : null)
          if (F.taskClosed)
            return (L.push('property'), L.length ? L.join(' ') : null)
          if (
            (F.linkHref
              ? L.push(s.linkHref, 'url')
              : (F.strong && L.push(s.strong),
                F.em && L.push(s.em),
                F.strikethrough && L.push(s.strikethrough),
                F.emoji && L.push(s.emoji),
                F.linkText && L.push(s.linkText),
                F.code && L.push(s.code),
                F.image && L.push(s.image),
                F.imageAltText && L.push(s.imageAltText, 'link'),
                F.imageMarker && L.push(s.imageMarker)),
            F.header && L.push(s.header, s.header + '-' + F.header),
            F.quote &&
              (L.push(s.quote),
              !v.maxBlockquoteDepth || v.maxBlockquoteDepth >= F.quote
                ? L.push(s.quote + '-' + F.quote)
                : L.push(s.quote + '-' + v.maxBlockquoteDepth)),
            F.list !== !1)
          ) {
            var ze = (F.listStack.length - 1) % 3
            ze
              ? ze === 1
                ? L.push(s.list2)
                : L.push(s.list3)
          ...
          return (
            F.trailingSpaceNewLine
              ...
              : F.trailingSpace &&
                L.push('trailing-space-' + (F.trailingSpace % 2 ? 'a' : 'b')),
            L.length ? L.join(' ') : null
          )
        }
        function Q(F, L) {
          if (F.match(k, !0)) return D(L)
        }
        function R(F, L) {
          var de = L.text(F, L)
          ...
          if (L.linkTitle) {
            ...
            ;(pe === '(' && (Ee = ')'),
              (Ee = (Ee + '').replace(/([.?*+^\[\]\\(){}|-])/g, '\\$1')))
            var ge = '^\\s*(?:[^' + Ee + '\\\\]+|\\\\\\\\|\\\\.)' + Ee
            if (F.match(new RegExp(ge), !0)) return s.linkHref
          }
          if (pe === '`') {
            var Oe = L.formatting
            ;(v.highlightFormatting && (L.formatting = 'code'), F.eatWhile('`'))
            var qe = F.current().length
          ...
          if (pe === '\\' && (F.next(), v.highlightFormatting)) {
            var je = D(L),
          ...
          if (pe === ']' && L.linkText) {
            ...
            return (
              (L.linkText = !1),
              (L.inline = L.f = F.match(/\(.*?\)| ?\[.*?\]/, !1) ? x : R),
              je
            )
          }
          if (
            pe === '<' &&
            F.match(/^(https?|ftps?):\/\/(?:[^\\>]|\\.)+>/, !1)
          ) {
            ;((L.f = L.inline = V),
              v.highlightFormatting && (L.formatting = 'link'))
            var je = D(L)
          ...
          if (
            ...
            var ke = F.string.indexOf('>', F.pos)
            if (ke != -1) {
              var Je = F.string.substring(F.start, ke)
              ;/markdown\s*=\s*('|"){0,1}1('|"){0,1}/.test(Je) &&
                (L.md_inside = !0)
            }
            return (F.backUp(1), (L.htmlState = o.startState(C)), O(F, L, q))
          }
          if (v.xml && pe === '<' && F.match(/^\/\w*?>/))
            return ((L.md_inside = !1), 'tag')
          if (pe === '*' || pe === '_') {
            for (
              var He = 1, Ge = F.pos == 1 ? ' ' : F.string.charAt(F.pos - 2);
              He < 3 && F.eat(pe);
            )
              He++
            var U = F.peek() || ' ',
          ...
          } else if (pe === ' ' && (F.eat('*') || F.eat('_'))) {
            if (F.peek() === ' ') return D(L)
            F.backUp(1)
          }
          if (v.strikethrough) {
            if (pe === '~' && F.eatWhile(pe)) {
          ...
          if (
            v.emoji &&
            pe === ':' &&
            F.match(/^(?:[a-z_\d+][a-z_\d+-]*|\-[a-z_\d+][a-z_\d+-]*):/)
          ) {
        ...
        function X(F) {
          return function (L, de) {
            ...
            return (L.match(K[F]), (de.linkHref = !0), D(de))
          }
        }
        function N(F, L) {
          return F.match(/^([^\]\\]|\\.)*\]:/, !1)
        ...
        var xe = {
          ...
          copyState: function (F) {
            return {
              ...
              thisLine: F.thisLine,
              block: F.block,
              htmlState: F.htmlState && o.copyState(C, F.htmlState),
              indentation: F.indentation,
              localMode: F.localMode,
              localState: F.localMode
                ? o.copyState(F.localMode, F.localState)
                : null,
              inline: F.inline,
              text: F.text,
              formatting: !1,
              ...
              taskList: F.taskList,
              list: F.list,
              listStack: F.listStack.slice(0),
              quote: F.quote,
              indentedCode: F.indentedCode,
              trailingSpace: F.trailingSpace,
              trailingSpaceNewLine: F.trailingSpaceNewLine,
              md_inside: F.md_inside,
              fencedEndRE: F.fencedEndRE,
            }
          },
          token: function (F, L) {
            if (((L.formatting = !1), F != L.thisLine.stream)) {
              if (((L.header = 0), (L.hr = !1), F.match(/^\s*$/, !0)))
                return (J(L), null)
              if (
                ...
                !L.localState && ((L.f = L.block), L.f != q))
              ) {
                var de = F.match(/^\s*/, !0)[0].replace(/\t/g, W).length
          ...
          innerMode: function (F) {
            return F.block == q
              ? { state: F.htmlState, mode: C }
              : F.localState
                ? { state: F.localState, mode: F.localMode }
                : { state: F, mode: xe }
          },
          indent: function (F, L, de) {
            return F.block == q && C.indent
              ? C.indent(F.htmlState, L, de)
              : F.localState && F.localMode.indent
                ? F.localMode.indent(F.localState, L, de)
                : o.Pass
          },
          blankLine: J,
          getType: D,
    ...
    ;(o.defineMode(
      ...
      function (v, C) {
        ...
        var s = {
            ...
            token: function (T, y) {
              if (((y.combineTokens = null), y.codeBlock))
                return T.match(/^```+/)
                  ? ((y.codeBlock = !1), null)
                  : (T.skipToEnd(), null)
              if ((T.sol() && (y.code = !1), T.sol() && T.match(/^```+/)))
                return (T.skipToEnd(), (y.codeBlock = !0), null)
              if (T.peek() === '`') {
                T.next()
                var c = T.pos
                T.eatWhile('`')
                var d = 1 + T.pos - c
                return (
                  y.code ? d === b && (y.code = !1) : ((b = d), (y.code = !0)),
                  null
                )
              } else if (y.code) return (T.next(), null)
              if (T.eatSpace()) return ((y.ateSpace = !0), null)
              if (
                (T.sol() || y.ateSpace) &&
                ((y.ateSpace = !1), C.gitHubSpice !== !1)
              ) {
                if (
                  T.match(
  ...
  ;(function (o) {
    ...
    ;(o.defineMode('go', function (p) {
      ...
      function h(k, z) {
        var M = k.next()
        if (M == '"' || M == "'" || M == '`')
          return ((z.tokenize = g(M)), z.tokenize(k, z))
        if (/[\d\.]/.test(M))
          return (
            M == '.'
              ? k.match(/^[0-9_]+([eE][\-+]?[0-9_]+)?/)
              : M == '0'
                ? k.match(/^[xX][0-9a-fA-F_]+/) || k.match(/^[0-7_]+/)
                : k.match(/^[0-9_]*\.?[0-9_]*([eE][\-+]?[0-9_]+)?/),
            'number'
          )
        if (/[\[\]{}\(\),;\:\.]/.test(M)) return ((s = M), null)
        if (M == '/') {
          if (k.eat('*')) return ((z.tokenize = T), T(k, z))
          if (k.eat('/')) return (k.skipToEnd(), 'comment')
        }
        if (S.test(M)) return (k.eatWhile(S), 'operator')
        k.eatWhile(/[\w\$_\xa1-\uffff]/)
        var w = k.current()
        return C.propertyIsEnumerable(w)
      ...
      function g(k) {
        return function (z, M) {
          ...
          return ((E || !(w || k == '`')) && (M.tokenize = h), 'string')
        }
      }
      function T(k, z) {
        for (var M = !1, w; (w = k.next()); ) {
          if (w == '/' && M) {
            z.tokenize = h
            break
          }
      ...
      function c(k, z, M) {
        return (k.context = new y(k.indented, z, M, null, k.context))
      }
      function d(k) {
        if (k.context.prev) {
          var z = k.context.type
          return (
            (z == ')' || z == ']' || z == '}') &&
              (k.indented = k.context.indented),
              ...
              s == '{'
                ...
                : s == '['
                  ...
                  : s == '('
                    ...
                    : s == 'case'
                      ? (M.type = 'case')
                      : ((s == '}' && M.type == '}') || s == M.type) && d(z),
              (z.startOfLine = !1)),
            w
          )
        },
        indent: function (k, z) {
          if (k.tokenize != h && k.tokenize != null) return o.Pass
          var M = k.context,
            w = z && z.charAt(0)
          if (M.type == 'case' && /^(?:case|default)\b/.test(z))
            return ((k.context.type = '}'), M.indented)
          var W = w == M.type
          return M.align ? M.column + (W ? 0 : 1) : M.indented + (W ? 0 : v)
        },
        electricChars: '{}):',
        closeBrackets: '()[]{}\'\'""``',
        fold: 'brace',
...
var au = Ke((iu, ou) => {
  ;(function (o) {
    ...
    ;(o.defineMode('http', function () {
      function p(T, y) {
        return (T.skipToEnd(), (y.cur = h), 'error')
      }
      function v(T, y) {
      ...
      function b(T, y) {
        return (T.skipToEnd(), (y.cur = h), null)
      }
      function S(T, y) {
        return (T.eatWhile(/\S/), (y.cur = s), 'string-2')
      }
      function s(T, y) {
        return T.match(/^HTTP\/\d\.\d$/) ? ((y.cur = h), 'keyword') : p(T, y)
      }
      function h(T) {
        return T.sol() && !T.eat(/[ \t]/)
          ? T.match(/^.*?:/)
      ...
      return {
        token: function (T, y) {
          var c = y.cur
          return c != h && c != g && T.eatSpace() ? null : c(T, y)
        },
    ...
    ;(o.defineMode(
      ...
      function (C, b) {
        ...
        function h(c) {
          ...
          c.tagName = null
          var k = S.indent(c, '', '')
          return ((c.tagName = d), k)
        }
        function g(c, d) {
          return d.context.mode == S ? T(c, d, d.context) : y(c, d, d.context)
        }
        function T(c, d, k) {
          if (k.depth == 2)
            return (
              c.match(/^.*?\*\//) ? (k.depth = 1) : c.skipToEnd(),
              'comment'
            )
          if (c.peek() == '{') {
            S.skipAttribute(k.state)
            var z = h(k.state),
              M = k.state.context
            if (M && c.match(/^[^>]*>\s*$/, !1)) {
              ...
              M.startOfLine
                ? (z -= C.indentUnit)
                : k.prev.state.lexical && (z = k.prev.state.lexical.indented)
            } else k.depth == 1 && (z += C.indentUnit)
            return (
              (d.context = new p(o.startState(s, z), s, 0, d.context)),
              null
            )
          }
          if (k.depth == 1) {
            ...
            if (c.match('/*')) return ((k.depth = 2), g(c, d))
          }
          var w = S.token(c, k.state),
            W = c.current(),
            E
          return (
            /\btag\b/.test(w)
        ...
        function y(c, d, k) {
          if (
            c.peek() == '<' &&
            !c.match(/^<([^<>]|<[^>]*>)+,\s*>/, !1) &&
            s.expressionAllowed(c, k.state)
          )
            return (
              (d.context = new p(
                o.startState(S, s.indent(k.state, '', '')),
                S,
                0,
                d.context
              )),
              s.skipExpression(k.state),
              null
            )
          var z = s.token(c, k.state)
          if (!z && k.depth != null) {
            var M = c.current()
            M == '{'
              ? k.depth++
              : M == '}' && --k.depth == 0 && (d.context = d.context.prev)
          }
          return z
        }
        return {
          ...
          token: g,
          indent: function (c, d, k) {
            return c.context.mode.indent(c.context.state, d, k)
          },
...
var gu = Ke((pu, hu) => {
  ;(function (o) {
    ...
    ;(o.defineMode('nginx', function (p) {
      function v(k) {
        for (var z = {}, M = k.split(' '), w = 0; w < M.length; ++w)
          z[M[w]] = !0
        return z
      }
      var C = v(
      ...
      function T(k, z) {
        k.eatWhile(/[\w\$_]/)
        var M = k.current()
        if (C.propertyIsEnumerable(M)) return 'keyword'
        if (b.propertyIsEnumerable(M)) return 'variable-2'
        if (S.propertyIsEnumerable(M)) return 'string-2'
        var w = k.next()
        if (w == '@') return (k.eatWhile(/[\w\\\-]/), g('meta', k.current()))
        if (w == '/' && k.eat('*')) return ((z.tokenize = y), y(k, z))
        if (w == '<' && k.eat('!')) return ((z.tokenize = c), c(k, z))
        if (w == '=') g(null, 'compare')
        else
          return (w == '~' || w == '|') && k.eat('=')
            ? g(null, 'compare')
            : w == '"' || w == "'"
              ? ((z.tokenize = d(w)), z.tokenize(k, z))
              : w == '#'
                ? (k.skipToEnd(), g('comment', 'comment'))
                : w == '!'
                  ? (k.match(/^\s*\w*/), g('keyword', 'important'))
                  : /\d/.test(w)
                    ? (k.eatWhile(/[\w.%]/), g('number', 'unit'))
                    : /[,.+>*\/]/.test(w)
                      ? g(null, 'select-op')
                      : /[;{}:\[\]]/.test(w)
                        ? g(null, w)
                        : (k.eatWhile(/[\w\\\-]/), g('variable', 'variable'))
      }
      function y(k, z) {
        for (var M = !1, w; (w = k.next()) != null; ) {
          if (M && w == '/') {
            z.tokenize = T
            break
          }
      ...
      function d(k) {
        return function (z, M) {
          for (var w = !1, W; (W = z.next()) != null && !(W == k && !w); )
            w = !w && W == '\\'
          return (w || (M.tokenize = T), g('string', 'string'))
        }
      }
      return {
        startState: function (k) {
          return { tokenize: T, baseIndent: k || 0, stack: [] }
        },
        token: function (k, z) {
          if (k.eatSpace()) return null
          h = null
          var M = z.tokenize(k, z),
          ...
          return (
            ...
            h == '{'
              ...
              : h == '}'
                ...
                : h == '@media'
                  ? z.stack.push('@media')
                  : w == '{' && h != 'comment' && z.stack.push('rule'),
            M
          )
        },
        indent: function (k, z) {
          var M = k.stack.length
          return (
            /^\}/.test(z) &&
              (M -= k.stack[k.stack.length - 1] == 'rule' ? 2 : 1),
            k.baseIndent + M * s
          )
        },
        electricChars: '}',
...
var bu = Ke((mu, vu) => {
  ;(function (o) {
    ...
    ;(o.defineMode('pascal', function () {
      function p(T) {
        for (var y = {}, c = T.split(' '), d = 0; d < c.length; ++d)
          y[c[d]] = !0
        return y
      }
      var v = p(
      ...
      function S(T, y) {
        var c = T.next()
        if (c == '#' && y.startOfLine) return (T.skipToEnd(), 'meta')
        if (c == '"' || c == "'") return ((y.tokenize = s(c)), y.tokenize(T, y))
        if (c == '(' && T.eat('*')) return ((y.tokenize = h), h(T, y))
        if (c == '{') return ((y.tokenize = g), g(T, y))
      ...
      function s(T) {
        return function (y, c) {
          for (var d = !1, k, z = !1; (k = y.next()) != null; ) {
            if (k == T && !d) {
              z = !0
              break
            }
  ...
  ;(function (o) {
    ...
    ;(o.defineMode('perl', function () {
      var S = {
        ...
        s = 'string-2',
        h = /[goseximacplud]/
      function g(c, d, k, z, M) {
        return (
          (d.chain = null),
          (d.style = null),
          (d.tail = null),
          (d.tokenize = function (w, W) {
            for (var E = !1, O, G = 0; (O = w.next()); ) {
              if (O === k[G] && !E)
                return (
                  k[++G] !== void 0
                    ? ((W.chain = k[G]), (W.style = z), (W.tail = M))
                    : M && w.eatWhile(M),
                  (W.tokenize = y),
                  z
                )
      ...
      function T(c, d, k) {
        return (
          (d.tokenize = function (z, M) {
            return (z.string == k && (M.tokenize = y), z.skipToEnd(), 'string')
          }),
          d.tokenize(c, d)
        )
      }
      function y(c, d) {
        ...
        if (k == '"' || k == "'") {
          if (v(c, 3) == '<<' + k) {
            ...
            if (M && c.eat(k)) return T(c, d, M)
            c.pos = z
          }
          return g(c, d, [k], 'string')
        }
        if (k == 'q') {
          var w = p(c, -2)
          if (!(w && /\w/.test(w))) {
            if (((w = p(c, 0)), w == 'x')) {
              ...
              if (w == '<') return (b(c, 2), g(c, d, ['>'], 'bracket'))
              if (/[\^'"!~\/]/.test(w))
                return (b(c, 1), g(c, d, [c.eat(w)], 'bracket'))
            } else if (w == 'r') {
              if (((w = p(c, 1)), w == '('))
                return (b(c, 2), g(c, d, [')'], s, h))
              if (w == '[') return (b(c, 2), g(c, d, [']'], s, h))
        ...
        if (k == '`') return g(c, d, [k], 'variable-2')
        if (k == '/')
          return /~\s*$/.test(v(c)) ? g(c, d, [k], s, h) : 'operator'
        if (k == '$') {
          var z = c.pos
          if (
            c.eatWhile(/\d/) ||
        ...
        if (k == '#' && p(c, -2) != '$') return (c.skipToEnd(), 'comment')
        if (/[:+\-\^*$&%@=<>!?|\/~\.]/.test(k)) {
          var z = c.pos
        ...
        if (/[A-Z]/.test(k)) {
          var W = p(c, -2),
            z = c.pos
          if ((c.eatWhile(/[A-Z_]/), /[\da-z]/.test(p(c, 0)))) c.pos = z
          else {
            var w = S[c.current()]
            return w
              ? (w[1] && (w = w[0]),
      ...
      return {
        startState: function () {
          return { tokenize: y, chain: null, style: null, tail: null }
        },
        token: function (c, d) {
...
var Su = Ke((ku, wu) => {
  ;(function (o) {
    ...
    'use strict'
    function p(T) {
      for (var y = {}, c = T.split(' '), d = 0; d < c.length; ++d) y[c[d]] = !0
      return y
    }
    function v(T, y, c) {
      return T.length == 0
        ? C(y)
        : function (d, k) {
            for (var z = T[0], M = 0; M < z.length; M++)
              if (d.match(z[M][0]))
                return ((k.tokenize = v(T.slice(1), y)), z[M][1])
            return ((k.tokenize = C(y, c)), 'string')
          }
    }
    function C(T, y) {
      return function (c, d) {
    ...
    function b(T, y, c, d) {
      ...
      if (d !== !1 && T.match(/^\$[a-zA-Z_][a-zA-Z0-9_]*/))
        return (
          ...
          T.match(/^->\w/, !1) &&
            (y.tokenize = v([[['->', null]], [[/[\w]+/, 'variable']]], c, d)),
          'variable-2'
        )
      for (
        var k = !1;
        ...
        if (!k && T.match(c)) {
          ;((y.tokenize = null), y.tokStack.pop(), y.tokStack.pop())
          break
        }
        k = T.next() == '\\' && !k
      }
      ...
      hooks: {
        ...
        '<': function (T, y) {
          ...
          if ((c = T.match(/^<<\s*/))) {
            var d = T.eat(/['"]/)
            T.eatWhile(/[\w\.]/)
            var k = T.current().slice(c[0].length + (d ? 2 : 1))
            if ((d && T.eat(d), k))
              return (
                (y.tokStack || (y.tokStack = [])).push(k, 0),
                (y.tokenize = C(k, d != "'")),
                'string'
              )
          }
        ...
        '{': function (T, y) {
          return (
            y.tokStack &&
              y.tokStack.length &&
              y.tokStack[y.tokStack.length - 1]++,
            !1
          )
        },
        '}': function (T, y) {
          return (
            y.tokStack &&
              y.tokStack.length > 0 &&
              !--y.tokStack[y.tokStack.length - 1] &&
              (y.tokenize = C(y.tokStack[y.tokStack.length - 2])),
            !1
          )
        },
      },
    ...
    ;(o.defineMode(
      'php',
      function (T, y) {
        var c = o.getMode(T, (y && y.htmlMode) || 'text/html'),
          d = o.getMode(T, g)
        function k(z, M) {
          var w = M.curMode == d
          if (
          ...
          if (z.match(/^<\?\w*/))
            return (
              (M.curMode = d),
              M.php || (M.php = o.startState(d, c.indent(M.html, '', ''))),
              (M.curState = M.php),
              'meta'
            )
        ...
        return {
          startState: function () {
            var z = o.startState(c),
              M = y.startOpen ? o.startState(d) : null
            return {
              html: z,
              php: M,
              curMode: y.startOpen ? d : c,
              curState: y.startOpen ? M : z,
              pending: null,
            }
          },
...
var Mu = Ke((Eu, zu) => {
  ;(function (o) {
    ...
    ;(o.defineMode('python', function (h, g) {
      for (
        var T = 'error',
          y = g.delimiters || g.singleDelimiters || /^[\(\)\[\]\{\}@,:`=;\.\\]/,
          c = [
            g.singleOperators,
            g.doubleOperators,
            g.doubleDelimiters,
        ...
        c[d] || c.splice(d--, 1)
      var k = g.hangingIndent || h.indentUnit,
        z = C,
        M = b
      ...
      var O = p(z),
        G = p(M)
      function J(K, X) {
        var N = K.sol() && X.lastToken != '\\'
        if ((N && (X.indent = K.indentation()), N && S(X).type == 'py')) {
          var H = S(X).offset
          if (K.eatSpace()) {
            ...
            return (
              le > H
                ? D(X)
                : le < H && R(K, X) && K.peek() != '#' && (X.errorToken = !0),
              null
            )
          } else {
            var xe = re(K, X)
            return (H > 0 && R(K, X) && (xe += ' ' + T), xe)
          }
        }
        return re(K, X)
      }
      function re(K, X, N) {
        if (K.eatSpace()) return null
        if (!N && K.match(/^#.*/)) return 'comment'
        if (K.match(/^[0-9\.]/, !1)) {
          var H = !1
          if (
            (K.match(/^[\d_]*\.\d+(e[\+\-]?\d+)?/i) && (H = !0),
            K.match(/^[\d_]+\.\d*/) && (H = !0),
            K.match(/^\.\d+/) && (H = !0),
            H)
          )
        ...
        if (K.match(E)) {
          ...
          return xe
            ? ((X.tokenize = q(K.current(), X.tokenize)), X.tokenize(K, X))
            : ((X.tokenize = I(K.current(), X.tokenize)), X.tokenize(K, X))
        }
        for (var F = 0; F < c.length; F++) if (K.match(c[F])) return 'operator'
        return K.match(y)
          ? 'punctuation'
          : X.lastToken == '.' && K.match(W)
            ? 'property'
            : K.match(O) || K.match(v)
              ? 'keyword'
              : K.match(G)
      ...
      function q(K, X) {
            ...
            return (
              ze == 'punctuation' &&
                (L.current() == '{'
                  ? (de.tokenize = le(F + 1))
                  : L.current() == '}' &&
                    (F > 1 ? (de.tokenize = le(F - 1)) : (de.tokenize = xe))),
              ze
            )
          }
        }
        function xe(F, L) {
          for (; !F.eol(); )
            if ((F.eatWhile(/[^'"\{\}\\]/), F.eat('\\'))) {
              if ((F.next(), N && F.eol())) return H
            } else {
              if (F.match(K)) return ((L.tokenize = X), H)
              if (F.match('{{')) return H
              if (F.match('{', !1))
                return (
                  (L.tokenize = le(0)),
                  F.current() ? H : L.tokenize(F, L)
                )
              if (F.match('}}')) return H
              if (F.match('}')) return T
              F.eat(/['"]/)
        ...
        function le(xe, F) {
          for (; !xe.eol(); )
            if ((xe.eatWhile(/[^'"\\]/), xe.eat('\\'))) {
              if ((xe.next(), N && xe.eol())) return H
            } else {
              if (xe.match(K)) return ((F.tokenize = X), H)
              xe.eat(/['"]/)
            }
          if (N) {
            if (g.singleLineStringErrors) return T
      ...
      function Q(K, X, N) {
        var H = K.match(/^[\s\[\{\(]*(?:#|$)/, !1) ? null : K.column() + 1
        X.scopes.push({ offset: X.indent + k, type: N, align: H })
      }
      function R(K, X) {
        for (
          var N = K.indentation();
      ...
      function V(K, X) {
        ...
        var N = X.tokenize(K, X),
          H = K.current()
        if (X.beginningOfLine && H == '@')
          return K.match(W, !1) ? 'meta' : w ? 'operator' : T
        if (
          ...
          H == ':' &&
            ...
            K.match(/^\s*(?:#|$)/, !1) &&
            D(X),
          H.length == 1 && !/string|comment/.test(N))
        ) {
          var le = '[({'.indexOf(H)
          if (
            ...
            if (S(X).type == H) X.indent = X.scopes.pop().offset - k
            else return T
        }
        return (
          X.dedent &&
      ...
      var x = {
        ...
        token: function (K, X) {
          ...
          return (
            H &&
              H != 'comment' &&
              (X.lastToken =
                H == 'keyword' || H == 'punctuation' ? K.current() : H),
        ...
        indent: function (K, X) {
          if (K.tokenize != J) return K.tokenize.isString ? o.Pass : 0
          var N = S(K),
            H =
              N.type == X.charAt(0) ||
              (N.type == 'py' &&
...
var qu = Ke((Au, Du) => {
  ;(function (o) {
    ...
    'use strict'
    function p(g) {
      for (var T = {}, y = 0, c = g.length; y < c; ++y) T[g[y]] = !0
      return T
    }
    var v = [
        'alias',
    ...
    ;(o.defineMode('ruby', function (g) {
      var T
      function y(E, O, G) {
        return (G.tokenize.push(E), E(O, G))
      }
      function c(E, O) {
        if (E.sol() && E.match('=begin') && E.eol())
          return (O.tokenize.push(W), 'comment')
        if (E.eatSpace()) return null
        var G = E.next(),
          J
        if (G == '`' || G == "'" || G == '"')
          return y(M(G, 'string', G == '"' || G == '`'), E, O)
        if (G == '/') return d(E) ? y(M(G, 'string-2', !0), E, O) : 'operator'
        if (G == '%') {
          var re = 'string',
            q = !0
          E.eat('s')
          ...
          var I = E.eat(/[^\w\s=]/)
          return I
            ? (s.propertyIsEnumerable(I) && (I = s[I]),
              y(M(I, re, q, !0), E, O))
            : 'operator'
        } else {
          if (G == '#') return (E.skipToEnd(), 'comment')
          if (
            G == '<' &&
            (J = E.match(/^<([-~])[\`\"\']?([a-zA-Z_?]\w*)[\`\"\']?(?:;|$)/))
          )
            return y(w(J[2], J[1]), E, O)
          if (G == '0')
            return (
              E.eat('x')
                ? E.eatWhile(/[\da-fA-F]/)
          ...
          if (G == '?') {
            ...
            if (
              G == '|' &&
              (O.varList || O.lastTok == '{' || O.lastTok == 'do')
            )
              return ((T = '|'), null)
            if (/[\(\)\[\]{}\\;]/.test(G)) return ((T = G), null)
            if (G == '-' && E.eat('>')) return 'arrow'
            if (/[=+\-\/*:\.^%<>~|]/.test(G)) {
              var D = E.eatWhile(/[=+\-\/*:\.^%<>~|]/)
              return (G == '.' && !D && (T = '.'), 'operator')
            } else return null
          }
        }
      }
      function d(E) {
        for (var O = E.pos, G = 0, J, re = !1, q = !1; (J = E.next()) != null; )
          if (q) q = !1
          else {
            if ('[{('.indexOf(J) > -1) G++
            else if (']})'.indexOf(J) > -1) {
          ...
          function (O, G) {
            if (O.peek() == '}') {
              if (E == 1)
                return (
                  G.tokenize.pop(),
                  G.tokenize[G.tokenize.length - 1](O, G)
                )
              G.tokenize[G.tokenize.length - 1] = k(E - 1)
            } else
              O.peek() == '{' && (G.tokenize[G.tokenize.length - 1] = k(E + 1))
            return c(O, G)
          }
        )
      }
      function z() {
        ...
        return function (O, G) {
          return E
            ? (G.tokenize.pop(), G.tokenize[G.tokenize.length - 1](O, G))
            : ((E = !0), c(O, G))
        }
      }
      function M(E, O, G, J) {
        return function (re, q) {
          ...
          for (
            ...
            if (G && D == '#' && !I) {
              if (re.eat('{')) {
                ;(E == '}' &&
                  (q.context = { prev: q.context, type: 'read-quoted-paused' }),
                  q.tokenize.push(k()))
                break
      ...
      function w(E, O) {
        return function (G, J) {
          return (
            O && G.eatSpace(),
            G.match(E) ? J.tokenize.pop() : G.skipToEnd(),
            'string'
          )
        }
      }
      function W(E, O) {
        return (
          E.sol() && E.match('=end') && E.eol() && O.tokenize.pop(),
          E.skipToEnd(),
          'comment'
        )
      }
      return {
        ...
        token: function (E, O) {
          ;((T = null), E.sol() && (O.indented = E.indentation()))
          var G = O.tokenize[O.tokenize.length - 1](E, O),
            J,
            re = T
          if (G == 'ident') {
            var q = E.current()
            ;((G =
              O.lastTok == '.'
                ...
                : C.propertyIsEnumerable(E.current())
                  ...
                  : /^[A-Z]/.test(q)
                    ? 'tag'
                    : O.lastTok == 'def' || O.lastTok == 'class' || O.varList
                      ? 'def'
                      : 'variable'),
              G == 'keyword' &&
                ((re = q),
                b.propertyIsEnumerable(q)
                  ...
                  : S.propertyIsEnumerable(q)
                    ...
                    : (((q == 'if' || q == 'unless') &&
                        ...
                        (q == 'do' && O.context.indented < O.indented)) &&
                      (J = 'indent')))
          }
          return (
            (T || (G && G != 'comment')) && (O.lastTok = re),
            T == '|' && (O.varList = !O.varList),
            J == 'indent' || /[\(\[\{]/.test(T)
              ? (O.context = {
                  prev: O.context,
                  type: T || G,
            ...
            E.eol() && (O.continuedLine = T == '\\' || G == 'operator'),
            G
          )
        },
        indent: function (E, O) {
          ...
          var G = O && O.charAt(0),
            ...
            re =
              J.type == h[G] ||
              (J.type == 'keyword' &&
                /^(?:end|until|else|elsif|when|rescue)\b/.test(O))
          return (
            J.indented +
            (re ? 0 : g.indentUnit) +
    ...
    ;(o.defineMode(
      ...
      function (p) {
        ...
        function M(q, I) {
          var D = q.peek()
          return D === ')'
            ? (q.next(), (I.tokenizer = J), 'operator')
            : D === '('
              ? (q.next(), q.eatSpace(), 'operator')
              : D === "'" || D === '"'
                ? ((I.tokenizer = W(q.next())), 'string')
                : ((I.tokenizer = W(')', !1)), 'string')
        }
        function w(q, I) {
          return function (D, Q) {
          ...
          function D(Q, R) {
            ...
            return X
              ? (V !== q && I && Q.next(),
                ...
                'string')
              : V === '#' && x === '{'
                ? ((R.tokenizer = E(D)), Q.next(), 'operator')
                : 'string'
          }
          return D
        }
        ...
        function J(q, I) {
          var D = q.peek()
          if (q.match('/*'))
            return ((I.tokenizer = w(q.indentation(), !0)), I.tokenizer(q, I))
          if (q.match('//'))
            return ((I.tokenizer = w(q.indentation(), !1)), I.tokenizer(q, I))
          if (q.match('#{')) return ((I.tokenizer = E(J)), 'operator')
          if (D === '"' || D === "'")
            return (q.next(), (I.tokenizer = W(D)), 'string')
          if (I.cursorHalf) {
            if (
              (D === '#' &&
                (q.next(), q.match(/[0-9a-fA-F]{6}|[0-9a-fA-F]{3}/))) ||
              q.match(/^-?[0-9\.]+/)
            )
              return (z(q) && (I.cursorHalf = 0), 'number')
            if (q.match(/^(px|em|in)\b/))
              return (z(q) && (I.cursorHalf = 0), 'unit')
            if (q.match(T)) return (z(q) && (I.cursorHalf = 0), 'keyword')
            if (q.match(/^url/) && q.peek() === '(')
              return ((I.tokenizer = M), z(q) && (I.cursorHalf = 0), 'atom')
            if (D === '$')
              return (
                q.next(),
                q.eatWhile(/[\w-]/),
            ...
            if (q.match(c)) return (z(q) && (I.cursorHalf = 0), 'operator')
            if (q.eatWhile(/[\w-]/))
              return (
                z(q) && (I.cursorHalf = 0),
                (k = q.current().toLowerCase()),
                S.hasOwnProperty(k)
                  ? 'atom'
                  : b.hasOwnProperty(k)
                    ? 'keyword'
                    : C.hasOwnProperty(k)
                      ? ((I.prevProp = q.current().toLowerCase()), 'property')
                      : 'tag'
              )
            if (z(q)) return ((I.cursorHalf = 0), null)
          } else {
            if (D === '-' && q.match(/^-\w+-/)) return 'meta'
            if (D === '.') {
              if ((q.next(), q.match(/^[\w-]+/))) return (O(I), 'qualifier')
              if (q.peek() === '#') return (O(I), 'tag')
            }
            if (D === '#') {
              if ((q.next(), q.match(/^[\w-]+/))) return (O(I), 'builtin')
              if (q.peek() === '#') return (O(I), 'tag')
            }
            if (D === '$') return (q.next(), q.eatWhile(/[\w-]/), 'variable-2')
            if (q.match(/^-?[0-9\.]+/)) return 'number'
            if (q.match(/^(px|em|in)\b/)) return 'unit'
            if (q.match(T)) return 'keyword'
            if (q.match(/^url/) && q.peek() === '(')
              return ((I.tokenizer = M), 'atom')
            if (D === '=' && q.match(/^=[\w-]+/)) return (O(I), 'meta')
            if (D === '+' && q.match(/^\+[\w-]+/)) return 'variable-3'
            if (
              (D === '@' && q.match('@extend') && (q.match(/\s*[\w]/) || G(I)),
              q.match(
            ...
            if (q.eatWhile(/[\w-]/))
              if (q.match(/ *: *[\w-\+\$#!\("']/, !1)) {
                ...
                return q.match(/ *:/, !1)
                  ? (O(I),
                    (I.cursorHalf = 1),
                    (I.prevProp = q.current().toLowerCase()),
                    'property')
                  : (q.match(/ *,/, !1) || O(I), 'tag')
            if (D === ':')
              return q.match(d)
                ? 'variable-3'
                : (q.next(), (I.cursorHalf = 1), 'operator')
          }
          return q.match(c) ? 'operator' : (q.next(), null)
        }
        function re(q, I) {
          q.sol() && (I.indentCount = 0)
          var D = I.tokenizer(q, I),
            Q = q.current()
          if (((Q === '@return' || Q === '}') && G(I), D !== null)) {
            for (
              var R = q.pos - Q.length,
                V = R + p.indentUnit * I.indentCount,
                x = [],
                K = 0;
              K < I.scopes.length;
              K++
        ...
        return {
          ...
          token: function (q, I) {
            var D = re(q, I)
            return ((I.lastToken = { style: D, content: q.current() }), D)
          },
          indent: function (q) {
...
var Hu = Ke((ju, Ru) => {
  ;(function (o) {
    ...
    ;(o.defineMode('shell', function () {
      var p = {}
      function v(d, k) {
        for (var z = 0; z < k.length; z++) p[k[z]] = d
      }
      var C = ['true', 'false'],
        b = [
          'if',
      ...
      function s(d, k) {
        ...
        if (M === "'" || M === '"' || M === '`')
          return (
            k.tokens.unshift(h(M, M === '`' ? 'quote' : 'string')),
            c(d, k)
          )
        if (M === '#')
          return z && d.eat('!')
            ? (d.skipToEnd(), 'meta')
            : (d.skipToEnd(), 'comment')
        if (M === '$') return (k.tokens.unshift(T), c(d, k))
        if (M === '+' || M === '=') return 'operator'
        if (M === '-') return (d.eat('-'), d.eatWhile(/\w/), 'attribute')
        if (M == '<') {
          if (d.match('<<')) return 'operator'
          var w = d.match(/^<-?\s*['"]?([^'"]*)['"]?/)
          if (w) return (k.tokens.unshift(y(w[1])), 'string-2')
        }
        if (/\d/.test(M) && (d.eatWhile(/\d/), d.eol() || !/\w/.test(d.peek())))
          return 'number'
        d.eatWhile(/[\w-]/)
        var W = d.current()
        ...
        return function (M, w) {
          for (var W, E = !1; (W = M.next()) != null; ) {
            if (W === z && !E) {
              w.tokens.shift()
              break
            } else if (W === '$' && !E && d !== "'" && M.peek() != z) {
              ;((E = !0), M.backUp(1), w.tokens.unshift(T))
              break
            } else {
              if (!E && d !== z && W === d)
                return (w.tokens.unshift(h(d, k)), c(M, w))
              if (!E && /['"]/.test(W) && !/['"]/.test(d)) {
      ...
      function g(d, k) {
        return function (z, M) {
          return ((M.tokens[0] = h(d, k)), z.next(), c(z, M))
        }
      }
      var T = function (d, k) {
        k.tokens.length > 1 && d.eat('$')
        var z = d.next()
        return /['"({]/.test(z)
          ? ((k.tokens[0] = h(
              z,
            ...
            c(d, k))
          : (/\d/.test(z) || d.eatWhile(/\w/), k.tokens.shift(), 'def')
      }
      function y(d) {
        return function (k, z) {
          return (
            k.sol() && k.string == d && z.tokens.shift(),
            k.skipToEnd(),
            'string-2'
          )
        }
  ...
  ;(function (o) {
    ...
    o.defineMode('sql', function (g, T) {
      var y = T.client || {},
        ...
        M = T.support || {},
        w = T.hooks || {},
        W = T.dateSQL || { date: !0, time: !0, timestamp: !0 },
        E = T.backslashStringEscapes !== !1,
        O = T.brackets || /^[\{}\(\)\[\]]/,
        G = T.punctuation || /^[;.,:]/
      function J(Q, R) {
        var V = Q.next()
        ...
        if (V == "'" || (V == '"' && M.doubleQuote))
          return ((R.tokenize = re(V)), R.tokenize(Q, R))
        if (
          ((M.nCharCast && (V == 'n' || V == 'N')) ||
            (M.charsetCast && V == '_' && Q.match(/[a-z][a-z0-9]*/i))) &&
          (Q.peek() == "'" || Q.peek() == '"')
        )
          return 'keyword'
        if (
          ...
          return (
            (R.tokenize = function (X, N) {
              return (N.tokenize = re(X.next(), !0))(X, N)
            }),
            'keyword'
          )
        ...
        if (
          (M.commentHash && V == '#') ||
          (V == '-' && Q.eat('-') && (!M.commentSpaceRequired || Q.eat(' ')))
        )
          return (Q.skipToEnd(), 'comment')
        if (V == '/' && Q.eat('*'))
          return ((R.tokenize = q(1)), R.tokenize(Q, R))
        if (V == '.') {
          ...
          if (O.test(V)) return 'bracket'
          if (G.test(V)) return (Q.eatWhile(G), 'punctuation')
          if (
            V == '{' &&
      ...
      return {
        startState: function () {
          return { tokenize: J, context: null }
        },
        token: function (Q, R) {
          if (
            (Q.sol() &&
              R.context &&
              R.context.align == null &&
              (R.context.align = !1),
            R.tokenize == J && Q.eatSpace())
          )
            return null
          var V = R.tokenize(Q, R)
          if (V == 'comment') return V
          R.context && R.context.align == null && (R.context.align = !0)
          var x = Q.current()
          return (
            x == '('
              ? I(Q, R, ')')
              : x == '['
                ? I(Q, R, ']')
                : R.context && R.context.type == x && D(R),
            V
          )
        },
        indent: function (Q, R) {
          var V = Q.context
          if (!V) return o.Pass
          var x = R.charAt(0) == V.type
          return V.align
            ? V.col + (x ? 0 : 1)
            : V.indent + (x ? 0 : g.indentUnit)
        },
        blockCommentStart: '/*',
        blockCommentEnd: '*/',
        lineComment: M.commentSlashSlash ? '//' : M.commentHash ? '#' : '--',
        closeBrackets: '()[]{}\'\'""``',
        config: T,
      }
    })
    ...
    function s(g) {
      for (var T = {}, y = g.split(' '), c = 0; c < y.length; ++c) T[y[c]] = !0
      return T
    }
    var h =
...
var ta = Ke(($u, Ku) => {
  ;(function (o) {
    ...
    o.defineMode('stylus', function (E) {
      ...
      function Oe($, B) {
        if (
          ...
          (B.context.line.firstWord = L ? L[0].replace(/^\s*/, '') : ''),
          (B.context.line.indent = $.indentation()),
          (ze = $.peek()),
          $.match('//'))
        )
          return ($.skipToEnd(), ['comment', 'comment'])
        if ($.match('/*')) return ((B.tokenize = qe), qe($, B))
        if (ze == '"' || ze == "'")
          return ($.next(), (B.tokenize = Se(ze)), B.tokenize($, B))
        if (ze == '@')
          ...
          : $.match(/^-?[0-9]?\.?[0-9]/)
            ...
            : ze == '!'
              ...
              : ze == '.' && $.match(/^\.[a-z][\w-]*/i)
                ? ['qualifier', 'qualifier']
                : $.match(V)
                  ? ($.peek() == '(' && (B.tokenize = je), ['property', 'word'])
                  : $.match(/^[a-z][\w-]*\(/i)
      ...
      function Se($) {
        return function (B, se) {
          for (var De = !1, nt; (nt = B.next()) != null; ) {
            if (nt == $ && !De) {
              $ == ')' && B.backUp(1)
              break
            }
      ...
      function ke($, B, se, De) {
        return (
          (De = De >= 0 ? De : O),
          ($.context = new Ze(se, B.indentation() + De, $.context)),
          se
        )
      }
      function Je($, B) {
        var se = $.context.indent - O
        return (
          (B = B || !1),
      ...
      function He($, B, se) {
        return de[se.context.type]($, B, se)
      }
      function Ge($, B, se, De) {
      ...
      function oe($, B) {
        return $ == '{' && B.match(/^\s*\$?[\w-]+/i, !1)
      }
      function Ue($, B) {
        return $ == ':' && B.match(/^[a-z-]+/, !1)
      }
      function we($) {
      ...
      function Le($) {
        var B = /^\s*[-_]*[a-z0-9]+[\w-]*/i,
          se = typeof $ == 'string' ? $.match(B) : $.string.match(B)
        return se ? se[0].replace(/^\s*/, '') : ''
      }
      return (
        (de.block = function ($, B, se) {
          if (($ == 'comment' && we(B)) || ($ == ',' && Me(B)) || $ == 'mixin')
            return ke(se, B, 'block', 0)
          if (oe($, B)) return ke(se, B, 'interpolation')
          if (
            Me(B) &&
            $ == ']' &&
            !/^\s*(\.|#|:|\[|\*|&)/.test(B.string) &&
            ...
            return ke(se, B, 'block', 0)
          if (fe($, B)) return ke(se, B, 'block')
          if ($ == '}' && Me(B)) return ke(se, B, 'block', 0)
          if ($ == 'variable-name')
            return B.string.match(/^\s?\$[\w-\.\[\]\'\"]+$/) || ce(Le(B))
              ? ke(se, B, 'variableName')
              : ke(se, B, 'variableName', 0)
          if ($ == '=')
            return !Me(B) && !ce(Le(B))
              ? ke(se, B, 'block', 0)
              : ke(se, B, 'block')
          if ($ == '*' && (Me(B) || B.match(/\s*(,|\.|#|\[|:|{)/, !1)))
            return ((ge = 'tag'), ke(se, B, 'block'))
          if (Ue($, B)) return ke(se, B, 'pseudo')
          if (/@(font-face|media|supports|(-moz-)?document)/.test($))
            return ke(se, B, Me(B) ? 'block' : 'atBlock')
          if (/@(-(moz|ms|o|webkit)-)?keyframes$/.test($))
            return ke(se, B, 'keyframes')
          if (/@extends?/.test($)) return ke(se, B, 'extend', 0)
          if ($ && $.charAt(0) == '@')
            return B.indentation() > 0 && Z(B.current().slice(1))
              ? ((ge = 'variable-2'), 'block')
              : /(@import|@require|@charset)/.test($)
                ? ke(se, B, 'block', 0)
                : ke(se, B, 'block')
          if ($ == 'reference' && Me(B)) return ke(se, B, 'block')
          if ($ == '(') return ke(se, B, 'parens')
          if ($ == 'vendor-prefixes') return ke(se, B, 'vendorPrefixes')
          if ($ == 'word') {
            var De = B.current()
            if (((ge = te(De)), ge == 'property'))
              return we(B) ? ke(se, B, 'block', 0) : ((ge = 'atom'), 'block')
            if (ge == 'tag') {
              if (
                (/embed|menu|pre|progress|sub|table/.test(De) && Z(Le(B))) ||
                B.string.match(
              ...
              if (
                ...
                return (
                  (ge = 'variable-2'),
                  ce(Le(B)) ? 'block' : ke(se, B, 'block', 0)
                )
              if (Me(B)) return ke(se, B, 'block')
            }
            if (ge == 'block-keyword')
              return (
                (ge = 'keyword'),
                B.current(/(if|unless)/) && !we(B)
                  ? 'block'
                  : ke(se, B, 'block')
              )
            if (De == 'return') return ke(se, B, 'block', 0)
            if (ge == 'variable-2' && B.string.match(/^\s?\$[\w-\.\[\]\'\"]+$/))
              return ke(se, B, 'block')
          }
          return se.context.type
        }),
        (de.parens = function ($, B, se) {
          if ($ == '(') return ke(se, B, 'parens')
          if ($ == ')')
            return se.context.prev.type == 'parens'
              ? Je(se)
              : (B.string.match(/^[a-z][\w-]*\(/i) && Me(B)) ||
                  ce(Le(B)) ||
                  /(\.|#|:|\[|\*|&|>|~|\+|\/)/.test(Le(B)) ||
                  (!B.string.match(/^-?[a-z][\w-\.\[\]\'\"]*\s*=/) && U(Le(B)))
                ? ke(se, B, 'block')
                : B.string.match(/^[\$-]?[a-z][\w-\.\[\]\'\"]*\s*=/) ||
                    B.string.match(/^\s*(\(|\)|[0-9])/) ||
                    B.string.match(/^\s+[a-z][\w-]*\(/i) ||
                    B.string.match(/^\s+[\$-]?[a-z]/i)
                  ? ke(se, B, 'block', 0)
                  : Me(B)
                    ? ke(se, B, 'block')
                    : ke(se, B, 'block', 0)
        ...
        (de.vendorPrefixes = function ($, B, se) {
          return $ == 'word'
            ? ((ge = 'property'), ke(se, B, 'block', 0))
            : Je(se)
        }),
        (de.pseudo = function ($, B, se) {
          return Z(Le(B.string))
            ? Ge($, B, se)
            : (B.match(/^[a-z-]+/),
              (ge = 'variable-3'),
              Me(B) ? ke(se, B, 'block') : Je(se))
        }),
        (de.atBlock = function ($, B, se) {
          if ($ == '(') return ke(se, B, 'atBlock_parens')
          if (fe($, B)) return ke(se, B, 'block')
          if (oe($, B)) return ke(se, B, 'interpolation')
          if ($ == 'word') {
            var De = B.current().toLowerCase()
            if (
          ...
          return (
            $ == 'operator' &&
              /^(not|and|or)$/.test(B.current()) &&
              (ge = 'keyword'),
            se.context.type
          )
        }),
        (de.atBlock_parens = function ($, B, se) {
          if ($ == '{' || $ == '}') return se.context.type
          if ($ == ')') return Me(B) ? ke(se, B, 'block') : ke(se, B, 'atBlock')
          if ($ == 'word') {
            var De = B.current().toLowerCase()
            return (
              (ge = te(De)),
          ...
          return de.atBlock($, B, se)
        }),
        (de.keyframes = function ($, B, se) {
          return B.indentation() == '0' &&
            (($ == '}' && we(B)) ||
              $ == ']' ||
              $ == 'hash' ||
              $ == 'qualifier' ||
            ...
            : $ == '{'
              ...
              : $ == '}'
                ? we(B)
                  ? Je(se, !0)
                  : ke(se, B, 'keyframes')
                : $ == 'unit' && /^[0-9]+\%$/.test(B.current())
                  ? ke(se, B, 'keyframes')
                  : $ == 'word' &&
                      ((ge = te(B.current())), ge == 'block-keyword')
                    ? ((ge = 'keyword'), ke(se, B, 'keyframes'))
                    : /@(font-face|media|supports|(-moz-)?document)/.test($)
                      ? ke(se, B, Me(B) ? 'block' : 'atBlock')
                      : $ == 'mixin'
                        ? ke(se, B, 'block', 0)
                        : se.context.type
        }),
        (de.interpolation = function ($, B, se) {
          return (
            $ == '{' && Je(se) && ke(se, B, 'block'),
            $ == '}'
              ? B.string.match(/^\s*(\.|#|:|\[|\*|&|>|~|\+|\/)/i) ||
                (B.string.match(/^\s*[a-z]/i) && U(Le(B)))
                ? ke(se, B, 'block')
                : !B.string.match(/^(\{|\s*\&)/) || B.match(/\s*[\w-]/, !1)
                  ? ke(se, B, 'block', 0)
                  : ke(se, B, 'block')
              : $ == 'variable-name'
                ? ke(se, B, 'variableName', 0)
                : ($ == 'word' &&
                    ((ge = te(B.current())), ge == 'tag' && (ge = 'atom')),
                  se.context.type)
          )
        }),
        (de.extend = function ($, B, se) {
          return $ == '[' || $ == '='
            ? 'extend'
            : $ == ']'
              ? Je(se)
              : $ == 'word'
                ? ((ge = te(B.current())), 'extend')
                : Je(se)
        }),
        (de.variableName = function ($, B, se) {
          return $ == 'string' ||
            $ == '[' ||
            $ == ']' ||
            B.current().match(/^(\.|\$)/)
            ? (B.current().match(/^\.[\w-]+/i) && (ge = 'variable-2'),
              'variableName')
            : Ge($, B, se)
        }),
        {
          ...
          token: function ($, B) {
            return !B.tokenize && $.eatSpace()
              ? null
              : ((pe = (B.tokenize || Oe)($, B)),
                pe && typeof pe == 'object' && ((Ee = pe[1]), (pe = pe[0])),
                (ge = pe),
                (B.state = de[B.state](Ee, $, B)),
                ge)
          },
          indent: function ($, B, se) {
            var De = $.context,
              nt = B && B.charAt(0),
              dt = De.indent,
              Pt = Le(B),
              Ft = se.match(/^\s*/)[0].replace(/\t/g, G).length,
    ...
    var p = [
      ...
      z = p.concat(v, C, b, S, s, g, T, h, y, c, d, k)
    function M(E) {
      return (
        (E = E.sort(function (O, G) {
          return G > O
        })),
        new RegExp('^((' + E.join(')|(') + '))\\b')
      )
    ...
    function w(E) {
      for (var O = {}, G = 0; G < E.length; ++G) O[E[G]] = !0
      return O
    }
    function W(E) {
...
var Xu = Ke((Gu, Zu) => {
  ;(function (o) {
    ...
    'use strict'
    function p(q) {
      for (var I = {}, D = 0; D < q.length; D++) I[q[D]] = !0
      return I
    }
    var v = p([
        '_',
    ...
    function w(q, I, D) {
      if ((q.sol() && (I.indented = q.indentation()), q.eatSpace())) return null
      var Q = q.peek()
      if (Q == '/') {
        if (q.match('//')) return (q.skipToEnd(), 'comment')
        if (q.match('/*')) return (I.tokenize.push(O), O(q, I))
      }
      if (q.match(z)) return 'builtin'
      if (q.match(M)) return 'attribute'
      if (q.match(g) || q.match(T) || q.match(y) || q.match(c)) return 'number'
      if (q.match(k)) return 'property'
      if (s.indexOf(Q) > -1) return (q.next(), 'operator')
      if (h.indexOf(Q) > -1) return (q.next(), q.match('..'), 'punctuation')
      var R
      if ((R = q.match(/("""|"|')/))) {
        var V = E.bind(null, R[0])
        return (I.tokenize.push(V), V(q, I))
      }
      if (q.match(d)) {
        var x = q.current()
        return S.hasOwnProperty(x)
          ? 'variable-2'
          : b.hasOwnProperty(x)
            ? 'atom'
            : v.hasOwnProperty(x)
              ? (C.hasOwnProperty(x) && (I.prev = 'define'), 'keyword')
              : D == 'define'
                ? 'def'
                : 'variable'
      }
          ...
          if (I.current() == '(') ++q
            ...
            if (q == 0)
              return (
                I.backUp(1),
                D.tokenize.pop(),
                D.tokenize[D.tokenize.length - 1](I, D)
              )
            --q
          }
        }
    ...
    function E(q, I, D) {
      for (var Q = q.length == 1, R, V = !1; (R = I.peek()); )
        if (V) {
          if ((I.next(), R == '(')) return (D.tokenize.push(W()), 'string')
          V = !1
        } else {
          if (I.match(q)) return (D.tokenize.pop(), 'string')
          ;(I.next(), (V = R == '\\'))
        }
    ...
    function G(q, I, D) {
      ;((this.prev = q), (this.align = I), (this.indented = D))
    }
    function J(q, I) {
      var D = I.match(/^\s*($|\/[\/\*])/, !1) ? null : I.column() + 1
      q.context = new G(q.context, D, q.indented)
    }
    function re(q) {
      q.context &&
        ((q.indented = q.context.indented), (q.context = q.context.prev))
    }
    ;(o.defineMode('swift', function (q) {
      return {
        ...
        token: function (I, D) {
          var Q = D.prev
          D.prev = null
          var R = D.tokenize[D.tokenize.length - 1] || w,
            V = R(I, D, Q)
          if (
            (!V || V == 'comment' ? (D.prev = Q) : D.prev || (D.prev = V),
            V == 'punctuation')
          ) {
            var x = /[\(\[\{]|([\]\)\}])/.exec(I.current())
            x && (x[1] ? re : J)(D, I)
          }
          return V
        },
    ...
    ;(o.defineMode('coffeescript', function (p, v) {
      ...
      function W(I, D) {
        if (I.sol()) {
          ...
          if (I.eatSpace()) {
            var R = I.indentation()
            return R > Q && D.scope.type == 'coffee'
              ? 'indent'
              : R < Q
                ? 'dedent'
                : null
        ...
        if (I.match('###')) return ((D.tokenize = O), D.tokenize(I, D))
        if (V === '#') return (I.skipToEnd(), 'comment')
        if (I.match(/^-?[0-9\.]/, !1)) {
          var x = !1
          if (
            (I.match(/^-?\d*\.\d+(e[\+\-]?\d+)?/i) && (x = !0),
            I.match(/^-?\d+\.\d*/) && (x = !0),
            I.match(/^-?\.\d+/) && (x = !0),
            x)
          )
            return (I.peek() == '.' && I.backUp(1), 'number')
          var K = !1
          if (
            (I.match(/^-?0x[0-9a-f]+/i) && (K = !0),
            I.match(/^-?[1-9]\d*(e[\+\-]?\d+)?/) && (K = !0),
            I.match(/^-?0(?![\dx])/i) && (K = !0),
            K)
          )
            return 'number'
        ...
        if (I.match(k))
          return ((D.tokenize = E(I.current(), !1, 'string')), D.tokenize(I, D))
        if (I.match(z)) {
          if (I.current() != '/' || I.match(/^.*\//, !1))
            return (
              (D.tokenize = E(I.current(), !0, 'string-2')),
              D.tokenize(I, D)
            )
          I.backUp(1)
        }
        return I.match(S) || I.match(T)
          ? 'operator'
          : I.match(s)
            ? 'punctuation'
            : I.match(w)
              ? 'atom'
              : I.match(g) || (D.prop && I.match(h))
                ? 'property'
                : I.match(d)
                  ? 'keyword'
                  : I.match(h)
      ...
      function E(I, D, Q) {
        return function (R, V) {
          for (; !R.eol(); )
            if ((R.eatWhile(/[^'"\/\\]/), R.eat('\\'))) {
              if ((R.next(), D && R.eol())) return Q
            } else {
              if (R.match(I)) return ((V.tokenize = W), Q)
              R.eat(/['"\/]/)
            }
          return (
            D && (v.singleLineStringErrors ? (Q = C) : (V.tokenize = W)),
            Q
          )
        }
      }
      ...
      function G(I, D, Q) {
        Q = Q || 'coffee'
        for (var R = 0, V = !1, x = null, K = D.scope; K; K = K.prev)
          if (K.type === 'coffee' || K.type == '}') {
            R = K.offset + p.indentUnit
            break
          }
        ;(Q !== 'coffee'
          ? ((V = null), (x = I.column() + I.current().length))
      ...
      function J(I, D) {
        if (D.scope.prev)
          if (D.scope.type === 'coffee') {
            for (var Q = I.indentation(), R = !1, V = D.scope; V; V = V.prev)
              if (Q === V.offset) {
                R = !0
                break
              }
      ...
      function re(I, D) {
        ...
        if (((V = '])}'.indexOf(R)), V !== -1)) {
          for (; D.scope.type == 'coffee' && D.scope.prev; )
            D.scope = D.scope.prev
          D.scope.type == R && (D.scope = D.scope.prev)
        }
        return (
          D.dedent &&
            I.eol() &&
      ...
      var q = {
        startState: function (I) {
          return {
            tokenize: W,
            scope: { offset: I || 0, type: 'coffee', prev: null, align: !1 },
            prop: !1,
            dedent: 0,
          }
        },
        token: function (I, D) {
          ...
          return (
            R &&
              R != 'comment' &&
              (Q && (Q.align = !0),
              (D.prop = R == 'punctuation' && I.current() == '.')),
            R
          )
        },
        indent: function (I, D) {
          if (I.tokenize != W) return 0
          var Q = I.scope,
            R = D && '])}'.indexOf(D.charAt(0)) > -1
          if (R) for (; Q.type == 'coffee' && Q.prev; ) Q = Q.prev
          var V = R && Q.type === D.charAt(0)
    ...
    ;(o.defineMode(
      ...
      function (p) {
        ...
        function Q(U, Z) {
          ...
          if (U.match('+#{', !1))
            return (U.next(), (Z.mixinCallAfter = !0), k(U, Z))
        }
        function R(U, Z) {
          if (Z.mixinCallAfter)
            return (
        ...
        function K(U, Z) {
          if (Z.isEach) {
            if (U.match(/^ in\b/))
              return ((Z.javaScriptLine = !0), (Z.isEach = !1), v)
        ...
        function N(U, Z) {
          ...
          if ((ce = U.match(/^(\w(?:[-:\w]*\w)?)\/?/)))
            return (
              ...
              Z.lastTag === 'script' &&
                (Z.scriptType = 'application/javascript'),
              'tag'
            )
        }
        function H(U, Z) {
        ...
        function qe(U, Z) {
          if (U.eat('.')) {
            ...
            return (
              Z.lastTag === 'script' &&
              Z.scriptType.toLowerCase().indexOf('javascript') != -1
          ...
          if (S.innerActive) {
            ...
            var y =
              z.close && !S.startingInner
                ? C(h, z.close, b.pos, z.parseDelimiters)
                : -1
            if (y == b.pos && !z.parseDelimiters)
              return (
                b.match(z.close),
                (S.innerActive = S.inner = null),
                z.delimStyle && z.delimStyle + ' ' + z.delimStyle + '-close'
              )
            y > -1 && (b.string = h.slice(0, y))
            ...
            return (
              ...
              y == b.pos &&
                ...
                (S.innerActive = S.inner = null),
              z.innerStyle &&
                (M ? (M = M + ' ' + z.innerStyle) : (M = z.innerStyle)),
              M
            )
          } else {
            ...
            var k = p.token(b, S.outer)
            return (s != 1 / 0 && (b.string = h), k)
          }
        },
...
function vc(o) {
  return (
    mc ? (o = o.replace('Ctrl', 'Cmd')) : (o = o.replace('Cmd', 'Ctrl')),
    o
  )
}
function Id(o, p, v, C) {
...
function qi(o, p, v, C, b, S) {
  ...
  for (var T = [], y = 0; y < g.length; y++) {
    var c = g[y]
    c.match(/^fa([srlb]|(-[\w-]*)|$)/) ? T.push(c) : s.classList.add(c)
  }
  if (((s.tabIndex = -1), T.length > 0)) {
    for (var d = document.createElement('i'), k = 0; k < T.length; k++) {
      var z = T[k]
      d.classList.add(z)
    }
    s.appendChild(d)
...
function Pi(o) {
  ...
  function b(K, X, N, H, le) {
    ;((N = N || K.getLineHandle(X)),
      (H = H || K.getTokenAt({ line: X, ch: 1 })),
      (le =
        le || (!!N.text && K.getTokenAt({ line: X, ch: N.text.length - 1 }))))
    var xe = H.type ? H.type.split(' ') : []
    return le && C(le).indentedCode
      ? 'indented'
      : xe.indexOf('comment') === -1
        ? !1
        : C(H).fencedChars || C(le).fencedChars || v(N)
          ? 'fenced'
          : 'single'
  }
  function S(K, X, N, H) {
...
`),
  ...
  var s = o.codemirror,
    ...
    y = s.getLineHandle(h.line),
    c = b(s, h.line, y, T),
    d,
    k,
    z
  if (c === 'single') {
    var M = y.text.slice(0, h.ch).replace('`', ''),
      w = y.text.slice(h.ch).replace('`', '')
    ;(s.replaceRange(
      M + w,
      { line: h.line, ch: 0 },
    ...
    if (h.line !== g.line || h.ch !== g.ch) {
      for (d = h.line; d >= 0 && ((y = s.getLineHandle(d)), !v(y)); d--);
...
`),
      ...
      if (
        ...
        for (d = q; d >= 0 && ((y = s.getLineHandle(d)), !v(y)); d--);
      if (k === void 0)
        for (
          z = s.lineCount(), k = q;
          k < z && ((y = s.getLineHandle(k)), !v(y));
          k++
        );
      ;(s.operation(function () {
        ;(s.replaceRange('', { line: d, ch: 0 }, { line: d + 1, ch: 0 }),
          s.replaceRange('', { line: k - 1, ch: 0 }, { line: k, ch: 0 }))
      }),
        s.focus())
    }
  else if (c === 'indented') {
    if (h.line !== g.line || h.ch !== g.ch)
      ((d = h.line), (k = g.line), g.ch === 0 && k--)
    else {
      for (d = h.line; d >= 0; d--)
        if (
          ((y = s.getLineHandle(d)),
          !y.text.match(/^\s*$/) && b(s, d, y) !== 'indented')
        ) {
          d += 1
          break
        }
      for (z = s.lineCount(), k = h.line; k < z; k++)
        if (
          ((y = s.getLineHandle(k)),
          !y.text.match(/^\s*$/) && b(s, k, y) !== 'indented')
        ) {
          k -= 1
          break
        }
    }
    var I = s.getLineHandle(k + 1),
      D = I && s.getTokenAt({ line: k + 1, ch: I.text.length - 1 }),
...
`,
    ...
    for (var R = d; R <= k; R++) s.indentLine(R, 'subtract')
    s.focus()
  } else {
    var V = h.line === g.line && h.ch === g.ch && h.ch === 0,
      x = h.line !== g.line
    V || x ? S(s, h, g, p) : Rr(s, !1, ['`', '`'])
  }
}
function ji(o) {
...
function bn(o) {
  ...
  if (
    (p.sideBySideRenderingFunction || (p.sideBySideRenderingFunction = y), S)
  ) {
      ...
      var C = /^(\s*)(\*|-|\+|\d*\.)(\s+)/,
        ...
        c = function (z, M, w) {
          ...
          return (
            W !== null
              ? (y(z, W[2]) && (E = ''),
                (M = W[1] + E + W[3] + M.replace(b, '').replace(g[z], '$1')))
              : w == !1 && (M = E + ' ' + M),
            M
          )
        },
...
Maximum file size is #image_max_size#.`,
    ...
    Te.prototype.render = function (o) {
      ...
      var p = this.options,
        ...
        C = {}
      function b(E) {
        let O = E.getInputField(),
          G = O.form
        if (G) {
          let J = Array.from(G.elements).filter(
              (q) =>
                !(
                  (q.closest && q.closest('.editor-toolbar')) ||
                  q.offsetParent === null
                )
            ),
            re = J.indexOf(O)
          re !== -1 && re + 1 < J.length && J[re + 1] && J[re + 1].focus()
        }
      }
      function S(E) {
        let O = E.getInputField(),
      ...
      for (var s in p.shortcuts)
        p.shortcuts[s] !== null &&
          Vn[s] !== null &&
          (function (E) {
            C[vc(p.shortcuts[E])] = function () {
              var O = Vn[E]
              typeof O == 'function'
                ? O(v)
                : typeof O == 'string' && window.open(O, '_blank')
            }
          })(s)
      ;((C.Enter = 'newlineAndIndentContinueMarkdownList'),
        (C.Tab = (E) => {
          let O = E.getSelection()
          O && O.length > 0 ? E.execCommand('indentMore') : b(E)
        }),
        (C['Shift-Tab'] = (E) => {
          let O = E.getSelection()
          O && O.length > 0 ? E.execCommand('indentLess') : S(E)
        }),
        (C.Esc = function (E) {
          E.getOption('fullScreen') && jr(v)
        }),
        (this.documentOnKeyDown = function (E) {
          ;((E = E || window.event),
            E.keyCode == 27 && v.codemirror.getOption('fullScreen') && jr(v))
        }),
      ...
      function k(E, O) {
        var G,
          J = window
            ...
            .width.replace('px', '')
        return (E < J ? (G = O + 'px') : (G = (O / E) * 100 + '%'), G)
      }
      var z = this
      function M(E, O) {
        ;(E.setAttribute('data-img-src', O.url),
          E.setAttribute(
            'style',
            '--bg-image:url(' +
              O.url +
              ...
              O.naturalWidth +
              'px;--height:' +
              k(O.naturalWidth, O.naturalHeight)
          ),
      ...
      function w() {
        p.previewImagesInEditor &&
          c.querySelectorAll('.cm-image-marker').forEach(function (E) {
            ...
            if (
              O.innerText.match(/^!\[.*?\]\(.*\)/g) &&
              !O.hasAttribute('data-img-src')
            ) {
              var G = O.innerText.match('\\((.*)\\)')
              if (
                ...
                if (p.imagesPreviewHandler) {
                  var re = p.imagesPreviewHandler(G[1])
                  typeof re == 'string' && (J = re)
                }
                if (window.EMDEimagesCache[J]) M(O, window.EMDEimagesCache[J])
                else {
    ...
    Te.prototype.uploadImage = function (o, p, v) {
      ...
      function S(g) {
        ...
        return g
          ...
          .replace('#image_size#', Fi(o.size, T))
          .replace('#image_max_size#', Fi(C.options.imageMaxSize, T))
      }
            ...
            ;(function (T) {
              ...
              if (
                (T === '|'
                  ? (y = Nd())
                  : T.children
                    ? (y = Id(T, C.options.toolbarTips, C.options.shortcuts, C))
                    : (y = qi(
                        T,
                        !0,
    ...
    Te.prototype.createStatusbar = function (o) {
      ...
      if (!(!o || o.length === 0)) {
                ...
                : g === 'cursor'
                  ...
                  : g === 'autosave'
                    ? (h = function (k) {
                        p.autosave != null &&
                          p.autosave.enabled === !0 &&
                          k.setAttribute('id', 'autosaved')
                      })
                    : g === 'upload-image' &&
                      (h = function (k) {
                        k.innerHTML = p.imageTexts.sbInit
                      }),
              C.push({
                className: g,
                defaultValue: h,
        ...
        for (T.className = 'editor-statusbar', b = 0; b < C.length; b++) {
          ...
          ;((c.className = y.className),
            typeof y.defaultValue == 'function' && y.defaultValue(c),
            typeof y.onUpdate == 'function' &&
              this.codemirror.on(
                'update',
                (function (k, z) {
                  return function () {
  ...
  return {
    ...
    init: async function () {
      ;(this.$root._editor &&
        ...
        this.editor.codemirror.on('changes', (d, k) => {
          try {
            let z = k[k.length - 1]
            if (z.origin === '+input') {
              let M = '(https://)',
              ...
              if (w.endsWith(M) && w !== '[]' + M) {
                let W = z.from,
                  E = z.to,
                  G = z.text.length > 1 ? 0 : W.ch
                setTimeout(() => {
                  d.setSelection(
                    { line: E.line, ch: G + w.lastIndexOf('(') + 1 },
                    { line: E.line, ch: G + w.lastIndexOf(')') }
                  )
                }, 25)
              }
            }
    ...
    getToolbar: function () {
      ...
      return (
        ...
        ['bold', 'italic', 'strike', 'link'].some((k) => y.includes(k)) &&
          ['heading'].some((k) => y.includes(k)) &&
          d.push('|'),
        y.includes('heading') &&
          d.push({
            name: 'heading',
        ...
        ['heading'].some((k) => y.includes(k)) &&
          ['blockquote', 'codeBlock', 'bulletList', 'orderedList'].some((k) =>
            y.includes(k)
          ) &&
          d.push('|'),
        y.includes('blockquote') &&
          d.push({
            name: 'quote',
            action: EasyMDE.toggleBlockquote,
            title: T.toolbar_buttons?.blockquote,
          }),
        y.includes('codeBlock') &&
          d.push({
            name: 'code',
            action: EasyMDE.toggleCodeBlock,
            title: T.toolbar_buttons?.code_block,
          }),
        y.includes('bulletList') &&
          d.push({
            name: 'unordered-list',
            action: EasyMDE.toggleUnorderedList,
            title: T.toolbar_buttons?.bullet_list,
          }),
        y.includes('orderedList') &&
          d.push({
            name: 'ordered-list',
        ...
        ['blockquote', 'codeBlock', 'bulletList', 'orderedList'].some((k) =>
          ...
          ['table', 'attachFiles'].some((k) => y.includes(k)) &&
          d.push('|'),
        y.includes('table') &&
          d.push({
            name: 'table',
