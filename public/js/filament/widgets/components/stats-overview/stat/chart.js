...
var os = (i) => i === 'reset' || i === 'none',
  ...
  et = class {
    ...
    _resolveElementOptions(t, e = 'default', s) {
      ...
      return (
        p.$shared && ((p.$shared = l), (o[a] = Object.freeze(Dn(p, l)))),
        p
      )
    }
      ...
      for (c = 0; c < e; ++c) {
        if (
          ...
          for (h = 0, d = u.length; h < d; ++h)
            ((v = u[h]),
              !T(v) && !I(v) && ((b = pe(s, p.data, p.gc, b, v)), (_ += m)))
  ...
  Qt = class {
    ...
    unregister(t) {
      let e = this.items,
        ...
        n = this.scope
      ;(s in e && delete e[s],
        n && s in O[n] && (delete O[n][s], this.override && delete vt[s]))
    }
  }
function Ar(i, t, e) {
...
function Jr(i, t, e) {
  let s = i.canvas,
    n = new MutationObserver((o) => {
      let a = !1
      for (let r of o)
        ((a = a || di(r.addedNodes, s)), (a = a && !di(r.removedNodes, s)))
      a && e()
    })
...
function Qr(i, t, e) {
  let s = i.canvas,
    n = new MutationObserver((o) => {
      let a = !1
      for (let r of o)
        ((a = a || di(r.removedNodes, s)), (a = a && !di(r.addedNodes, s)))
      a && e()
    })
  return (n.observe(document, { childList: !0, subtree: !0 }), n)
}
