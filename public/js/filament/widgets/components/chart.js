...
function Nn(i) {
  ...
  let r =
    s.xmin !== t.min || s.xmax !== t.max || s.ymin !== e.min || s.ymax !== e.max
  return (Object.assign(s, n), r)
}
var ys = (i) => i === 0 || i === 1,
  bo = (i, t, e) => -(Math.pow(2, 10 * (i -= 1)) * Math.sin(((i - t) * H) / e)),
...
function ia(i, t, e, s, n) {
  ...
  if (
    ...
    for (r = 0, o = i.length; r < o; ++r)
      ((a = i[r]),
        (l = kh(c, a, i[Math.min(r + 1, o - (s ? 0 : 1)) % o], t.tension)),
        (a.cp1x = l.previous.x),
        (a.cp1y = l.previous.y),
        (a.cp2x = l.next.x),
        (a.cp2y = l.next.y),
    ...
    ((b = t[v % o]),
      !b.skip &&
        ...
        y !== _ &&
          ...
          p !== null &&
            k() &&
            (m.push(Oo({ start: p, end: v, loop: d, count: o, style: f })),
            (p = null)),
          (T = v),
          (_ = y))))
  return (
    p !== null && m.push(Oo({ start: p, end: u, loop: d, count: o, style: f })),
    m
  )
}
function tr(i, t) {
  ...
  gt = class {
    ...
    _update(t) {
      ...
      ;(this.update(t || 'default'),
        (e._clip = qh(
          E(this.options.clip, Zh(e.xScale, e.yScale, this.getMaxOverflow()))
        )))
    }
    update(t) {}
    draw() {
    ...
    _resolveElementOptions(t, e = 'default', s) {
      ...
      return (
        g.$shared && ((g.$shared = l), (r[o] = Object.freeze(ga(g, l)))),
        g
      )
    }
    ...
    updateElement(t, e, s, n) {
      ir(n) ? Object.assign(t, s) : this._resolveAnimations(e, n).update(t, s)
    }
...
var il = {
  ...
  logarithmic(i, t, e) {
    ...
    return s === 1 || s === 2 || s === 5 ? il.numeric.call(this, i, t, e) : ''
  },
}
function fu(i, t) {
...
function Ns(i, t, e, s, n) {
  let r = E(s, 0),
    ...
    h
  for (
    e = Math.ceil(e), n && ((l = n - s), (e = l / Math.floor(l / e))), h = r;
    h < 0;
  )
...
function vu(i, t, e, s) {
  ...
  if (i.isHorizontal()) {
    if (((f = nt(s, r, a)), F(e))) {
      ...
      e === 'center' ? (m = (c.bottom + c.top) / 2 + g - t) : (m = xa(i, e, t))
    d = a - r
  } else {
    if (F(e)) {
      let y = Object.keys(e)[0],
      ...
      e === 'center' ? (f = (c.left + c.right) / 2 - p + t) : (f = xa(i, e, t))
...
var be = class i extends pt {
      ...
      for (c = 0; c < e; ++c) {
        if (
          ...
          for (h = 0, u = d.length; h < u; ++h)
            ((_ = d[h]),
              !P(_) && !B(_) && ((y = bi(s, g.data, g.gc, y, _)), (b += p)))
    ...
    drawTitle() {
      ...
      e === 'bottom' || e === 'center' || F(e)
        ...
        : (l += o.top)
      let { titleX: c, titleY: h, maxWidth: u, rotation: d } = vu(this, l, e, a)
      Qt(t, s.text, 0, 0, r, {
        color: s.color,
        maxWidth: u,
        rotation: d,
...
function td(i) {
  return !qn() || (typeof OffscreenCanvas < 'u' && i instanceof OffscreenCanvas)
    ? fr
    : mr
}
var gr = class {
      ...
      ;(e &&
        ...
        V(r, (o) => {
          let a = o.options,
            ...
            c = yr(l, a),
            h = E(a.type, o.dtype)
          ;((a.position === void 0 || Ia(a.position, c) !== Ia(o.dposition)) &&
...
function _d(i, t, e) {
  let { x: s, y: n, startAngle: r, pixelMargin: o, fullCircles: a } = t,
    ...
    h
  for (
    e && dl(i, t, r + H), i.beginPath(), i.arc(s, n, c, r + H, r, !0), h = 0;
    h < a;
    ++h
  )
    i.stroke()
...
var Nt = class extends pt {
  ...
  get segments() {
    return this._segments || (this._segments = la(this, this.options.segment))
  }
  first() {
    let t = this.segments,
      e = this.points
...
function yl(i, t) {
  ...
  return (
    ...
    e.length
      ? new Nt({ points: e, options: { tension: 0 }, _loop: s, _fullLoop: s })
      : null
  )
}
function Ra(i) {
...
var af = {
    ...
    afterDatasetsUpdate(i, t, e) {
      ...
      for (o = 0; o < s; ++o)
        ((r = i.getDatasetMeta(o)),
          ...
          n.push(l))
      for (o = 0; o < s; ++o)
        ((l = n[o]), !(!l || l.fill === !1) && (l.fill = $d(n, o, e.propagate)))
    },
    beforeDraw(i, t, e) {
    ...
    beforeDatasetDraw(i, t, e) {
      let s = t.meta.$filler
      !Ra(s) || e.drawTime !== 'beforeDatasetDraw' || cr(i.ctx, s, i.chartArea)
    },
        ...
        ;(l.setWidth(this.width),
          w
            ...
            : v > 0 &&
              ...
              m.line++,
              (K = m.y =
                nt(r, this.top + x + u, this.bottom - e[m.line].height))))
        let lt = l.x(L)
        ;(b(lt, K, k),
...
var Li = class extends pt {
  ...
  getContext() {
    return (
      this.$context ||
      (this.$context = _f(this.chart.getContext(), this, this._tooltipItems))
    )
  }
  getTitle(t, e) {
    let { callbacks: s } = e,
...
var Tf = (i, t) => (i === null ? null : tt(Math.round(i), 0, t)),
  Ke = class extends be {
    ...
    parse(t, e) {
      ...
      return (
        (e =
          isFinite(e) && s[e] === t ? e : Mf(s, t, E(e, t), this._addedLabels)),
        Tf(e, s.length - 1)
      )
    }
    determineDataLimits() {
...
var we = class extends be {
  ...
  buildTicks() {
    ...
    return (
      (this._unit =
        e.unit ||
        (s.autoSkip
          ? Ka(e.minUnit, this.min, this.max, this._getLabelCapacity(r))
          : zf(this, a.length, e.minUnit, this.min, this.max))),
      (this._majorUnit =
        !s.major.enabled || this._unit === 'year' ? void 0 : Vf(this._unit)),
      this.initOffsets(n),
      t.reverse && a.reverse(),
  ...
  _getLabelCapacity(t) {
    let e = this.options.time,
      ...
      r = this._tickFormatFunction(t, 0, Qa(this, [t], this._majorUnit), n),
...
var Nr = class {
  ...
  W = class i {
    ...
    get fastNumbers() {
      return (
        this.fastNumbersCached == null && (this.fastNumbersCached = im(this)),
      ...
      return sn(this, t, zr, () => {
        ...
        return (
          this.monthsCache[n][t] ||
            (this.monthsCache[n][t] = tm((r) => this.extract(r, s, 'month'))),
          this.monthsCache[n][t]
        )
      })
    }
    ...
    eras(t) {
      return sn(this, t, Br, () => {
        ...
        return (
          this.eraCache[t] ||
            (this.eraCache[t] = [I.utc(-40, 1, 1), I.utc(2017, 1, 1)].map((s) =>
              this.extract(s, e, 'era')
            )),
          this.eraCache[t]
        )
      })
    ...
    getWeekSettings() {
      return this.weekSettings ? this.weekSettings : rn() ? Kf(this.locale) : Sl
    }
    getStartOfWeek() {
    ...
    static parseFormat(t) {
      ...
      for (let o = 0; o < t.length; o++) {
        ...
        a === "'"
          ...
          : n || a === e
            ? (s += a)
            : (s.length > 0 && r.push({ literal: /^\s+$/.test(s), val: s }),
              (s = a),
              (e = a))
      }
      return (
...
var Z = class i {
  ...
  plus(t) {
    ...
    let e = i.fromDurationLike(t),
      s = {}
    for (let n of Te)
      (ce(e.values, n) || ce(this.values, n)) && (s[n] = e.get(n) + this.get(n))
...
var Yt = class i {
  ...
  toString() {
    return this.isValid ? `[${this.s.toISO()} \u2013 ${this.e.toISO()})` : ui
  }
  [Symbol.for('nodejs.util.inspect.custom')]() {
    return this.isValid
  ...
  toISOTime(t) {
    return this.isValid ? `${this.s.toISOTime(t)}/${this.e.toISOTime(t)}` : ui
  }
  toFormat(t, { separator: e = ' \u2013 ' } = {}) {
    return this.isValid ? `${this.s.toFormat(t)}${e}${this.e.toFormat(t)}` : ui
  }
  toDuration(t, e) {
    return this.isValid
...
function qm(i, t, e) {
  ...
  for (let [l, c] of s)
    e.indexOf(l) >= 0 &&
      ...
      (a = r.plus(n)),
      a > t
        ? (n[l]--, (i = r.plus(n)), i > t && ((a = i), n[l]--, (i = r.plus(n))))
        : (i = a))
  return [i, n, a, o]
}
function gc(i, t, e, s) {
...
function Qm(i, t) {
  let e = wt(t),
    ...
    u = wt(t, '{2,4}'),
    d = wt(t, '{4,6}'),
    f = (p) => ({ regex: RegExp(Jm(p.val)), deser: ([y]) => y, literal: !0 }),
    g = ((p) => {
...
var fs = class {
  ...
  explainFromTokens(t) {
    if (this.isValid) {
      ...
      if (ce(s, 'a') && ce(s, 'H'))
        throw new Tt("Can't include meridiem when specifying 24-hour format")
      return {
        input: t,
        tokens: this.tokens,
        regex: this.regex,
...
function _c(i, t, e) {
  let { result: s, zone: n, specificOffset: r, invalidReason: o } = lo(i, t, e)
  return [s, n, r, o]
}
function co(i, t) {
  if (!i) return null
...
function dg(i) {
  if ((gs === void 0 && (gs = R.now()), i.type !== 'iana')) return i.offset(gs)
  let t = i.name,
    e = go.get(t)
...
var gs,
  ...
  I = class i {
    ...
    toFormat(t, e = {}) {
      return this.isValid
        ? st.create(this.loc.redefaultToEN(e)).formatDateTimeFromString(this, t)
        : ho
    }
    toLocaleString(t = re, e = {}) {
      return this.isValid
